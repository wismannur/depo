...
//
// Table class for tr_inv_master
//
class ctr_inv_master extends cTable {
	var $inv_id;
	var $inv_number;
	var $inv_date;
	var $tax_type;
	...
	function __construct() {
		...
		$this->TableVar = 'tr_inv_master';
		$this->TableName = 'tr_inv_master';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`tr_inv_master`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// inv_id
		$this->inv_id = new cField('tr_inv_master', 'tr_inv_master', 'x_inv_id', 'inv_id', '`inv_id`', '`inv_id`', 3, -1, FALSE, '`inv_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// inv_number
		$this->inv_number = new cField('tr_inv_master', 'tr_inv_master', 'x_inv_number', 'inv_number', '`inv_number`', '`inv_number`', 200, -1, FALSE, '`inv_number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->inv_number->Sortable = TRUE; // Allow sort
		$this->fields['inv_number'] = &$this->inv_number;

		// inv_date
		$this->inv_date = new cField('tr_inv_master', 'tr_inv_master', 'x_inv_date', 'inv_date', '`inv_date`', ew_CastDateFieldForLike('`inv_date`', 7, "DB"), 133, 7, FALSE, '`inv_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tax_type
		$this->tax_type = new cField('tr_inv_master', 'tr_inv_master', 'x_tax_type', 'tax_type', '`tax_type`', '`tax_type`', 3, -1, FALSE, '`tax_type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->tax_type->Sortable = TRUE; // Allow sort
		$this->tax_type->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->tax_type->PleaseSelectText = $Language->Phrase("PleaseSelect"); // PleaseSelect text
		$this->tax_type->OptionCount = 2;
		$this->tax_type->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['tax_type'] = &$this->tax_type;

		// due_date
		$this->due_date = new cField('tr_inv_master', 'tr_inv_master', 'x_due_date', 'due_date', '`due_date`', ew_CastDateFieldForLike('`due_date`', 0, "DB"), 133, 0, FALSE, '`due_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->due_date->Sortable = TRUE; // Allow sort
		$this->due_date->FldDefaultErrMsg = str_replace("%s", $GLOBALS["EW_DATE_FORMAT"], $Language->Phrase("IncorrectDate"));
		$this->fields['due_date'] = &$this->due_date;

		// customer_id
		$this->customer_id = new cField('tr_inv_master', 'tr_inv_master', 'x_customer_id', 'customer_id', '`customer_id`', '`customer_id`', 3, -1, FALSE, '`customer_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// customer_name
		$this->customer_name = new cField('tr_inv_master', 'tr_inv_master', 'x_customer_name', 'customer_name', '`customer_name`', '`customer_name`', 200, -1, FALSE, '`customer_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->customer_name->Sortable = TRUE; // Allow sort
		$this->fields['customer_name'] = &$this->customer_name;

		// address1
		$this->address1 = new cField('tr_inv_master', 'tr_inv_master', 'x_address1', 'address1', '`address1`', '`address1`', 200, -1, FALSE, '`address1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->address1->Sortable = TRUE; // Allow sort
		$this->fields['address1'] = &$this->address1;

		// address2
		$this->address2 = new cField('tr_inv_master', 'tr_inv_master', 'x_address2', 'address2', '`address2`', '`address2`', 200, -1, FALSE, '`address2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->address2->Sortable = TRUE; // Allow sort
		$this->fields['address2'] = &$this->address2;

		// address3
		$this->address3 = new cField('tr_inv_master', 'tr_inv_master', 'x_address3', 'address3', '`address3`', '`address3`', 200, -1, FALSE, '`address3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->address3->Sortable = TRUE; // Allow sort
		$this->fields['address3'] = &$this->address3;

		// wilayah_id
		$this->wilayah_id = new cField('tr_inv_master', 'tr_inv_master', 'x_wilayah_id', 'wilayah_id', '`wilayah_id`', '`wilayah_id`', 3, -1, FALSE, '`wilayah_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// subwil_id
		$this->subwil_id = new cField('tr_inv_master', 'tr_inv_master', 'x_subwil_id', 'subwil_id', '`subwil_id`', '`subwil_id`', 3, -1, FALSE, '`subwil_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// area_id
		$this->area_id = new cField('tr_inv_master', 'tr_inv_master', 'x_area_id', 'area_id', '`area_id`', '`area_id`', 3, -1, FALSE, '`area_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// tax_number
		$this->tax_number = new cField('tr_inv_master', 'tr_inv_master', 'x_tax_number', 'tax_number', '`tax_number`', '`tax_number`', 200, -1, FALSE, '`tax_number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->tax_number->Sortable = TRUE; // Allow sort
		$this->fields['tax_number'] = &$this->tax_number;

		// tc_number
		$this->tc_number = new cField('tr_inv_master', 'tr_inv_master', 'x_tc_number', 'tc_number', '`tc_number`', '`tc_number`', 200, -1, FALSE, '`tc_number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->tc_number->Sortable = TRUE; // Allow sort
		$this->fields['tc_number'] = &$this->tc_number;

		// inv_amt
		$this->inv_amt = new cField('tr_inv_master', 'tr_inv_master', 'x_inv_amt', 'inv_amt', '`inv_amt`', '`inv_amt`', 5, -1, FALSE, '`inv_amt`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// discount
		$this->discount = new cField('tr_inv_master', 'tr_inv_master', 'x_discount', 'discount', '`discount`', '`discount`', 5, -1, FALSE, '`discount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// total_discount
		$this->total_discount = new cField('tr_inv_master', 'tr_inv_master', 'x_total_discount', 'total_discount', '`total_discount`', '`total_discount`', 5, -1, FALSE, '`total_discount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// is_tax
		$this->is_tax = new cField('tr_inv_master', 'tr_inv_master', 'x_is_tax', 'is_tax', '`is_tax`', '`is_tax`', 202, -1, FALSE, '`is_tax`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// tax_total
		$this->tax_total = new cField('tr_inv_master', 'tr_inv_master', 'x_tax_total', 'tax_total', '`tax_total`', '`tax_total`', 5, -1, FALSE, '`tax_total`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// inv_total
		$this->inv_total = new cField('tr_inv_master', 'tr_inv_master', 'x_inv_total', 'inv_total', '`inv_total`', '`inv_total`', 5, -1, FALSE, '`inv_total`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// paid_amt
		$this->paid_amt = new cField('tr_inv_master', 'tr_inv_master', 'x_paid_amt', 'paid_amt', '`paid_amt`', '`paid_amt`', 5, -1, FALSE, '`paid_amt`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// user_id
		$this->user_id = new cField('tr_inv_master', 'tr_inv_master', 'x_user_id', 'user_id', '`user_id`', '`user_id`', 3, -1, FALSE, '`user_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->user_id->Sortable = TRUE; // Allow sort
		$this->user_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['user_id'] = &$this->user_id;

		// lastupdate
		$this->lastupdate = new cField('tr_inv_master', 'tr_inv_master', 'x_lastupdate', 'lastupdate', '`lastupdate`', ew_CastDateFieldForLike('`lastupdate`', 0, "DB"), 135, 0, FALSE, '`lastupdate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// koreksi
		$this->koreksi = new cField('tr_inv_master', 'tr_inv_master', 'x_koreksi', 'koreksi', '`koreksi`', '`koreksi`', 5, -1, FALSE, '`koreksi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->koreksi->Sortable = TRUE; // Allow sort
		$this->koreksi->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['koreksi'] = &$this->koreksi;

		// tanggal_koreksi
		$this->tanggal_koreksi = new cField('tr_inv_master', 'tr_inv_master', 'x_tanggal_koreksi', 'tanggal_koreksi', '`tanggal_koreksi`', ew_CastDateFieldForLike('`tanggal_koreksi`', 0, "DB"), 133, 0, FALSE, '`tanggal_koreksi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->tanggal_koreksi->Sortable = TRUE; // Allow sort
		$this->tanggal_koreksi->FldDefaultErrMsg = str_replace("%s", $GLOBALS["EW_DATE_FORMAT"], $Language->Phrase("IncorrectDate"));
		$this->fields['tanggal_koreksi'] = &$this->tanggal_koreksi;

		// sales_id
		$this->sales_id = new cField('tr_inv_master', 'tr_inv_master', 'x_sales_id', 'sales_id', '`sales_id`', '`sales_id`', 3, -1, FALSE, '`sales_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// sopir
		$this->sopir = new cField('tr_inv_master', 'tr_inv_master', 'x_sopir', 'sopir', '`sopir`', '`sopir`', 200, -1, FALSE, '`sopir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->sopir->Sortable = TRUE; // Allow sort
		$this->fields['sopir'] = &$this->sopir;

		// no_mobil
		$this->no_mobil = new cField('tr_inv_master', 'tr_inv_master', 'x_no_mobil', 'no_mobil', '`no_mobil`', '`no_mobil`', 200, -1, FALSE, '`no_mobil`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->no_mobil->Sortable = TRUE; // Allow sort
		$this->fields['no_mobil'] = &$this->no_mobil;

		// kode_depo
		$this->kode_depo = new cField('tr_inv_master', 'tr_inv_master', 'x_kode_depo', 'kode_depo', '`kode_depo`', '`kode_depo`', 200, -1, FALSE, '`kode_depo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->kode_depo->Sortable = TRUE; // Allow sort
		$this->fields['kode_depo'] = &$this->kode_depo;

		// paid
		$this->paid = new cField('tr_inv_master', 'tr_inv_master', 'x_paid', 'paid', '`paid`', '`paid`', 202, -1, FALSE, '`paid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
	...
	function GetDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "tr_inv_item") {
			$sDetailUrl = $GLOBALS["tr_inv_item"]->GetListUrl() . "?" . EW_TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$sDetailUrl .= "&fk_inv_id=" . urlencode($this->inv_id->CurrentValue);
		}
		if ($sDetailUrl == "") {
			$sDetailUrl = "tr_inv_masterlist.php";
		}
		return $sDetailUrl;
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`tr_inv_master`";
	}
	...
	function Delete(&$rs, $where = "", $curfilter = TRUE) {
		...
		// Cascade delete detail table 'tr_inv_item'
		if (!isset($GLOBALS["tr_inv_item"])) $GLOBALS["tr_inv_item"] = new ctr_inv_item();
		$rscascade = $GLOBALS["tr_inv_item"]->LoadRs("`master_id` = " . ew_QuotedValue($rs['inv_id'], EW_DATATYPE_NUMBER, "DB")); 
		$dtlrows = ($rscascade) ? $rscascade->GetRows() : array();

		// Call Row Deleting event
		foreach ($dtlrows as $dtlrow) {
			$bDelete = $GLOBALS["tr_inv_item"]->Row_Deleting($dtlrow);
			if (!$bDelete) break;
		}
		if ($bDelete) {
			foreach ($dtlrows as $dtlrow) {
				$bDelete = $GLOBALS["tr_inv_item"]->Delete($dtlrow); // Delete
				if ($bDelete === FALSE)
					break;
			}
		}
		...
		if ($bDelete) {
			foreach ($dtlrows as $dtlrow) {
				$GLOBALS["tr_inv_item"]->Row_Deleted($dtlrow);
			}
		}
		if ($bDelete)
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "tr_inv_masteredit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "tr_inv_masteradd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("tr_inv_masterview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("tr_inv_masterview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "tr_inv_masteradd.php?" . $this->UrlParm($parm);
		else
			$url = "tr_inv_masteradd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("tr_inv_masteredit.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("tr_inv_masteredit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("tr_inv_masteradd.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("tr_inv_masteradd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("tr_inv_masterdelete.php", $this->UrlParm());
	}
	...
	function LoadListRowValues(&$rs) {
		...
		$this->koreksi->setDbValue($rs->fields('koreksi'));
		$this->tanggal_koreksi->setDbValue($rs->fields('tanggal_koreksi'));
		$this->sales_id->setDbValue($rs->fields('sales_id'));
		$this->sopir->setDbValue($rs->fields('sopir'));
		$this->no_mobil->setDbValue($rs->fields('no_mobil'));
	...
	function RenderEditRow() {
		...
		$this->due_date->EditValue = ew_FormatDateTime($this->due_date->CurrentValue, 8);
		...
		$this->tc_number->EditValue = $this->tc_number->CurrentValue;
		...
		$this->tax_total->EditValue = $this->tax_total->CurrentValue;
		...
		$this->tanggal_koreksi->EditValue = ew_FormatDateTime($this->tanggal_koreksi->CurrentValue, 8);
		...
		$this->sopir->EditValue = $this->sopir->CurrentValue;
		...
		$this->no_mobil->EditValue = $this->no_mobil->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->koreksi->Exportable) $Doc->ExportCaption($this->koreksi);
					if ($this->tanggal_koreksi->Exportable) $Doc->ExportCaption($this->tanggal_koreksi);
					if ($this->sales_id->Exportable) $Doc->ExportCaption($this->sales_id);
					if ($this->sopir->Exportable) $Doc->ExportCaption($this->sopir);
					if ($this->no_mobil->Exportable) $Doc->ExportCaption($this->no_mobil);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->koreksi->Exportable) $Doc->ExportField($this->koreksi);
						if ($this->tanggal_koreksi->Exportable) $Doc->ExportField($this->tanggal_koreksi);
						if ($this->sales_id->Exportable) $Doc->ExportField($this->sales_id);
						if ($this->sopir->Exportable) $Doc->ExportField($this->sopir);
						if ($this->no_mobil->Exportable) $Doc->ExportField($this->no_mobil);
	...
	function GetAutoFill($id, $val) {
		...
		if (preg_match('/^x(\d)*_customer_id$/', $id)) {
			$conn = &$this->Connection();
			$sSqlWrk = "SELECT `customer_name` AS FIELD0, `address1` AS FIELD1, `address2` AS FIELD2, `address3` AS FIELD3, `wilayah_id` AS FIELD4, `subwil_id` AS FIELD5, `area_id` AS FIELD6, `tax` AS FIELD7, `sales_id` AS FIELD8 FROM `tbl_customer`";
			...
			if ($rs = ew_LoadRecordset($sSqlWrk, $conn)) {
				while ($rs && !$rs->EOF) {
					...
					$this->wilayah_id->setDbValue($rs->fields[4]);
					$this->subwil_id->setDbValue($rs->fields[5]);
					$this->area_id->setDbValue($rs->fields[6]);
					...
					$ar[] = ($this->address3->AutoFillOriginalValue) ? $this->address3->CurrentValue : $this->address3->EditValue;
	...
	function Row_Inserting($rsold, &$rsnew) {
		...
		$rsnew["inv_number"] = GetNextInvNumber();
		return TRUE;
	}
	...
	function Row_Rendered() {
		...
		if (CurrentPageID() == "add") {
			$this->inv_number->CurrentValue = GetNextInvNumber();
			$this->inv_number->EditValue = $this->inv_number->CurrentValue; 
		}
