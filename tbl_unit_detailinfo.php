...
$tbl_unit_detail = NULL;

//
// Table class for tbl_unit_detail
//
class ctbl_unit_detail extends cTable {
	var $unit_id;
	var $product_id;
	var $unit_name;
	var $qty_in_unit;
	...
	function __construct() {
		...
		$this->TableVar = 'tbl_unit_detail';
		$this->TableName = 'tbl_unit_detail';
		$this->TableType = 'LINKTABLE';

		// Update Table
		$this->UpdateTable = "`tbl_unit_detail`";
		...
		// unit_id
		$this->unit_id = new cField('tbl_unit_detail', 'tbl_unit_detail', 'x_unit_id', 'unit_id', '`unit_id`', '`unit_id`', 200, -1, FALSE, '`unit_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// product_id
		$this->product_id = new cField('tbl_unit_detail', 'tbl_unit_detail', 'x_product_id', 'product_id', '`product_id`', '`product_id`', 3, -1, FALSE, '`product_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// unit_name
		$this->unit_name = new cField('tbl_unit_detail', 'tbl_unit_detail', 'x_unit_name', 'unit_name', '`unit_name`', '`unit_name`', 200, -1, FALSE, '`unit_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->unit_name->Sortable = TRUE; // Allow sort
		$this->fields['unit_name'] = &$this->unit_name;

		// qty_in_unit
		$this->qty_in_unit = new cField('tbl_unit_detail', 'tbl_unit_detail', 'x_qty_in_unit', 'qty_in_unit', '`qty_in_unit`', '`qty_in_unit`', 2, -1, FALSE, '`qty_in_unit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// unit_cost
		$this->unit_cost = new cField('tbl_unit_detail', 'tbl_unit_detail', 'x_unit_cost', 'unit_cost', '`unit_cost`', '`unit_cost`', 5, -1, FALSE, '`unit_cost`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// unit_price
		$this->unit_price = new cField('tbl_unit_detail', 'tbl_unit_detail', 'x_unit_price', 'unit_price', '`unit_price`', '`unit_price`', 131, -1, FALSE, '`unit_price`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// udet_id
		$this->udet_id = new cField('tbl_unit_detail', 'tbl_unit_detail', 'x_udet_id', 'udet_id', '`udet_id`', '`udet_id`', 3, -1, FALSE, '`udet_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// product_code
		$this->product_code = new cField('tbl_unit_detail', 'tbl_unit_detail', 'x_product_code', 'product_code', '`product_code`', '`product_code`', 200, -1, FALSE, '`product_code`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function GetMasterFilter() {
		...
		// Master filter
		$sMasterFilter = "";
		if ($this->getCurrentMasterTable() == "tbl_products") {
			if ($this->product_id->getSessionValue() <> "")
				$sMasterFilter .= "`product_id`=" . ew_QuotedValue($this->product_id->getSessionValue(), EW_DATATYPE_NUMBER, "db_inventory_pusat");
			else
				return "";
		}
	...
	function GetDetailFilter() {
		...
		if ($this->getCurrentMasterTable() == "tbl_products") {
			if ($this->product_id->getSessionValue() <> "")
				$sDetailFilter .= "`product_id`=" . ew_QuotedValue($this->product_id->getSessionValue(), EW_DATATYPE_NUMBER, "db_inventory_pusat");
			else
				return "";
		}
	...
	// Master filter
	function SqlMasterFilter_tbl_products() {
		return "`product_id`=@product_id@";
	}

	// Detail filter
	function SqlDetailFilter_tbl_products() {
		return "`product_id`=@product_id@";
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`tbl_unit_detail`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "tbl_unit_detaillist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		global $Language;
		if ($pageName == "tbl_unit_detailview.php")
			return $Language->Phrase("View");
		elseif ($pageName == "tbl_unit_detailedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "tbl_unit_detailadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("tbl_unit_detailview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("tbl_unit_detailview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "tbl_unit_detailadd.php?" . $this->UrlParm($parm);
		else
			$url = "tbl_unit_detailadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("tbl_unit_detailedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("tbl_unit_detailadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("tbl_unit_detaildelete.php", $this->UrlParm());
	}

	// Add master url
	function AddMasterUrl($url) {
		if ($this->getCurrentMasterTable() == "tbl_products" && strpos($url, EW_TABLE_SHOW_MASTER . "=") === FALSE) {
