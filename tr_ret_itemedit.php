...
$tr_ret_item_edit = NULL; // Initialize page object first

class ctr_ret_item_edit extends ctr_ret_item {
	...
	// Page object name
	var $PageObjName = 'tr_ret_item_edit';
...
// Create page object
if (!isset($tr_ret_item_edit)) $tr_ret_item_edit = new ctr_ret_item_edit();

// Page init
$tr_ret_item_edit->Page_Init();

// Page main
$tr_ret_item_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tr_ret_item_edit->Page_Render();
?>
...
var CurrentForm = ftr_ret_itemedit = new ew_Form("ftr_ret_itemedit", "edit");

// Validate form
ftr_ret_itemedit.Validate = function() {
...
ftr_ret_itemedit.Form_CustomValidate = 
...
ftr_ret_itemedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
ftr_ret_itemedit.Lists["x_item_id"] = {"LinkField":"x_product_id","Ajax":true,"AutoFill":true,"DisplayFields":["x_product_name","","",""],"ParentFields":[],"ChildFields":["x_udet_id"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"view_products_unit_price"};
ftr_ret_itemedit.Lists["x_item_id"].Data = "<?php echo $tr_ret_item_edit->item_id->LookupFilterQuery(FALSE, "edit") ?>";
ftr_ret_itemedit.AutoSuggests["x_item_id"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $tr_ret_item_edit->item_id->LookupFilterQuery(TRUE, "edit"))) ?>;
ftr_ret_itemedit.Lists["x_udet_id"] = {"LinkField":"x_udet_id","Ajax":true,"AutoFill":true,"DisplayFields":["x_unit_name","","",""],"ParentFields":["x_item_id"],"ChildFields":[],"FilterFields":["x_product_id"],"Options":[],"Template":"","LinkTable":"tbl_unit_detail"};
ftr_ret_itemedit.Lists["x_udet_id"].Data = "<?php echo $tr_ret_item_edit->udet_id->LookupFilterQuery(FALSE, "edit") ?>";
ftr_ret_itemedit.Lists["x_is_bs[]"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ftr_ret_itemedit.Lists["x_is_bs[]"].Options = <?php echo json_encode($tr_ret_item_edit->is_bs->Options()) ?>;
...
<?php $tr_ret_item_edit->ShowPageHeader(); ?>
<?php
$tr_ret_item_edit->ShowMessage();
?>
<form name="ftr_ret_itemedit" id="ftr_ret_itemedit" class="<?php echo $tr_ret_item_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($tr_ret_item_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tr_ret_item_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="tr_ret_item">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($tr_ret_item_edit->IsModal) ?>">
...
<?php } ?>
<?php if (!$tr_ret_item_edit->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($tr_ret_item_edit->IsMobileOrModal) { ?>
<div class="ewEditDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_tr_ret_itemedit" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
<?php if ($tr_ret_item->row_id->Visible) { // row_id ?>
<?php if ($tr_ret_item_edit->IsMobileOrModal) { ?>
	<div id="r_row_id" class="form-group">
		<label id="elh_tr_ret_item_row_id" class="<?php echo $tr_ret_item_edit->LeftColumnClass ?>"><?php echo $tr_ret_item->row_id->FldCaption() ?></label>
		<div class="<?php echo $tr_ret_item_edit->RightColumnClass ?>"><div<?php echo $tr_ret_item->row_id->CellAttributes() ?>>
<span id="el_tr_ret_item_row_id">
<span<?php echo $tr_ret_item->row_id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $tr_ret_item->row_id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="tr_ret_item" data-field="x_row_id" name="x_row_id" id="x_row_id" value="<?php echo ew_HtmlEncode($tr_ret_item->row_id->CurrentValue) ?>">
<?php echo $tr_ret_item->row_id->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_row_id">
		<td class="col-sm-2"><span id="elh_tr_ret_item_row_id"><?php echo $tr_ret_item->row_id->FldCaption() ?></span></td>
		<td<?php echo $tr_ret_item->row_id->CellAttributes() ?>>
<span id="el_tr_ret_item_row_id">
<span<?php echo $tr_ret_item->row_id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $tr_ret_item->row_id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="tr_ret_item" data-field="x_row_id" name="x_row_id" id="x_row_id" value="<?php echo ew_HtmlEncode($tr_ret_item->row_id->CurrentValue) ?>">
<?php echo $tr_ret_item->row_id->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
...
<?php if ($tr_ret_item_edit->IsMobileOrModal) { ?>
	<div id="r_master_id" class="form-group">
		<label id="elh_tr_ret_item_master_id" for="x_master_id" class="<?php echo $tr_ret_item_edit->LeftColumnClass ?>"><?php echo $tr_ret_item->master_id->FldCaption() ?></label>
		<div class="<?php echo $tr_ret_item_edit->RightColumnClass ?>"><div<?php echo $tr_ret_item->master_id->CellAttributes() ?>>
...
<?php if ($tr_ret_item_edit->IsMobileOrModal) { ?>
	<div id="r_item_id" class="form-group">
		<label id="elh_tr_ret_item_item_id" class="<?php echo $tr_ret_item_edit->LeftColumnClass ?>"><?php echo $tr_ret_item->item_id->FldCaption() ?></label>
		<div class="<?php echo $tr_ret_item_edit->RightColumnClass ?>"><div<?php echo $tr_ret_item->item_id->CellAttributes() ?>>
...
<script type="text/javascript">
ftr_ret_itemedit.CreateAutoSuggest({"id":"x_item_id","forceSelect":true});
</script>
...
<?php if ($tr_ret_item_edit->IsMobileOrModal) { ?>
	<div id="r_item_code" class="form-group">
		<label id="elh_tr_ret_item_item_code" for="x_item_code" class="<?php echo $tr_ret_item_edit->LeftColumnClass ?>"><?php echo $tr_ret_item->item_code->FldCaption() ?></label>
		<div class="<?php echo $tr_ret_item_edit->RightColumnClass ?>"><div<?php echo $tr_ret_item->item_code->CellAttributes() ?>>
...
<?php if ($tr_ret_item_edit->IsMobileOrModal) { ?>
	<div id="r_udet_id" class="form-group">
		<label id="elh_tr_ret_item_udet_id" for="x_udet_id" class="<?php echo $tr_ret_item_edit->LeftColumnClass ?>"><?php echo $tr_ret_item->udet_id->FldCaption() ?></label>
		<div class="<?php echo $tr_ret_item_edit->RightColumnClass ?>"><div<?php echo $tr_ret_item->udet_id->CellAttributes() ?>>
...
<?php if ($tr_ret_item_edit->IsMobileOrModal) { ?>
	<div id="r_item_qty" class="form-group">
		<label id="elh_tr_ret_item_item_qty" for="x_item_qty" class="<?php echo $tr_ret_item_edit->LeftColumnClass ?>"><?php echo $tr_ret_item->item_qty->FldCaption() ?></label>
		<div class="<?php echo $tr_ret_item_edit->RightColumnClass ?>"><div<?php echo $tr_ret_item->item_qty->CellAttributes() ?>>
...
<?php if ($tr_ret_item_edit->IsMobileOrModal) { ?>
	<div id="r_item_price" class="form-group">
		<label id="elh_tr_ret_item_item_price" for="x_item_price" class="<?php echo $tr_ret_item_edit->LeftColumnClass ?>"><?php echo $tr_ret_item->item_price->FldCaption() ?></label>
		<div class="<?php echo $tr_ret_item_edit->RightColumnClass ?>"><div<?php echo $tr_ret_item->item_price->CellAttributes() ?>>
...
<?php if ($tr_ret_item_edit->IsMobileOrModal) { ?>
	<div id="r_item_disc" class="form-group">
		<label id="elh_tr_ret_item_item_disc" for="x_item_disc" class="<?php echo $tr_ret_item_edit->LeftColumnClass ?>"><?php echo $tr_ret_item->item_disc->FldCaption() ?></label>
		<div class="<?php echo $tr_ret_item_edit->RightColumnClass ?>"><div<?php echo $tr_ret_item->item_disc->CellAttributes() ?>>
...
<?php if ($tr_ret_item_edit->IsMobileOrModal) { ?>
	<div id="r_item_amt" class="form-group">
		<label id="elh_tr_ret_item_item_amt" for="x_item_amt" class="<?php echo $tr_ret_item_edit->LeftColumnClass ?>"><?php echo $tr_ret_item->item_amt->FldCaption() ?></label>
		<div class="<?php echo $tr_ret_item_edit->RightColumnClass ?>"><div<?php echo $tr_ret_item->item_amt->CellAttributes() ?>>
...
<?php if ($tr_ret_item_edit->IsMobileOrModal) { ?>
	<div id="r_is_bs" class="form-group">
		<label id="elh_tr_ret_item_is_bs" class="<?php echo $tr_ret_item_edit->LeftColumnClass ?>"><?php echo $tr_ret_item->is_bs->FldCaption() ?></label>
		<div class="<?php echo $tr_ret_item_edit->RightColumnClass ?>"><div<?php echo $tr_ret_item->is_bs->CellAttributes() ?>>
...
<input type="hidden" data-table="tr_ret_item" data-field="x_item_name" name="x_item_name" id="x_item_name" value="<?php echo ew_HtmlEncode($tr_ret_item->item_name->CurrentValue) ?>">
</span>
<span id="el_tr_ret_item_unit_id">
<input type="hidden" data-table="tr_ret_item" data-field="x_unit_id" name="x_unit_id" id="x_unit_id" value="<?php echo ew_HtmlEncode($tr_ret_item->unit_id->CurrentValue) ?>">
</span>
<?php if (!$tr_ret_item_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $tr_ret_item_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $tr_ret_item_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
ftr_ret_itemedit.Init();
</script>
<?php
$tr_ret_item_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$tr_ret_item_edit->Page_Terminate();
?>
