...
$tr_km_item_ar2_view = NULL; // Initialize page object first

class ctr_km_item_ar2_view extends ctr_km_item_ar2 {
	...
	// Page object name
	var $PageObjName = 'tr_km_item_ar2_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["row_id"] <> "") {
				...
				$sReturnUrl = "tr_km_item_ar2list.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "tr_km_item_ar2list.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "tr_km_item_ar2list.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($tr_km_item_ar2_view)) $tr_km_item_ar2_view = new ctr_km_item_ar2_view();

// Page init
$tr_km_item_ar2_view->Page_Init();

// Page main
$tr_km_item_ar2_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tr_km_item_ar2_view->Page_Render();
?>
...
var CurrentForm = ftr_km_item_ar2view = new ew_Form("ftr_km_item_ar2view", "view");

// Form_CustomValidate event
ftr_km_item_ar2view.Form_CustomValidate = 
...
ftr_km_item_ar2view.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<div class="ewToolbar">
<?php $tr_km_item_ar2_view->ExportOptions->Render("body") ?>
<?php
	foreach ($tr_km_item_ar2_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php $tr_km_item_ar2_view->ShowPageHeader(); ?>
<?php
$tr_km_item_ar2_view->ShowMessage();
?>
<form name="ftr_km_item_ar2view" id="ftr_km_item_ar2view" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($tr_km_item_ar2_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tr_km_item_ar2_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="tr_km_item_ar2">
<input type="hidden" name="modal" value="<?php echo intval($tr_km_item_ar2_view->IsModal) ?>">
...
<?php if ($tr_km_item_ar2->row_id->Visible) { // row_id ?>
	<tr id="r_row_id">
		...
		<td data-name="row_id"<?php echo $tr_km_item_ar2->row_id->CellAttributes() ?>>
<span id="el_tr_km_item_ar2_row_id">
<span<?php echo $tr_km_item_ar2->row_id->ViewAttributes() ?>>
<?php echo $tr_km_item_ar2->row_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tr_km_item_ar2->master_id->Visible) { // master_id ?>
	<tr id="r_master_id">
		...
		<td data-name="master_id"<?php echo $tr_km_item_ar2->master_id->CellAttributes() ?>>
<span id="el_tr_km_item_ar2_master_id">
<span<?php echo $tr_km_item_ar2->master_id->ViewAttributes() ?>>
<?php echo $tr_km_item_ar2->master_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $tr_km_item_ar2->inv_number->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $tr_km_item_ar2->inv_date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $tr_km_item_ar2->inv_amt->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $tr_km_item_ar2->paid_amt->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tr_km_item_ar2->acc_no->Visible) { // acc_no ?>
	<tr id="r_acc_no">
		...
		<td data-name="acc_no"<?php echo $tr_km_item_ar2->acc_no->CellAttributes() ?>>
<span id="el_tr_km_item_ar2_acc_no">
<span<?php echo $tr_km_item_ar2->acc_no->ViewAttributes() ?>>
<?php echo $tr_km_item_ar2->acc_no->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
ftr_km_item_ar2view.Init();
</script>
<?php
$tr_km_item_ar2_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$tr_km_item_ar2_view->Page_Terminate();
?>
