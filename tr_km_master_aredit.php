...
$tr_km_master_ar_edit = NULL; // Initialize page object first

class ctr_km_master_ar_edit extends ctr_km_master_ar {
	...
	// Page object name
	var $PageObjName = 'tr_km_master_ar_edit';
	...
	function ValidateForm() {
		...
		if (in_array("tr_km_item_ar", $DetailTblVar) && $GLOBALS["tr_km_item_ar"]->DetailEdit) {
			...
			if ($bUpdateRow) {
				...
				if ($EditRow) {
					if (in_array("tr_km_item_ar", $DetailTblVar) && $GLOBALS["tr_km_item_ar"]->DetailEdit) {
						...
						$EditRow = $GLOBALS["tr_km_item_ar_grid"]->GridUpdate();
	...
	function SetupDetailParms() {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("tr_km_item_ar", $DetailTblVar)) {
				...
				if ($GLOBALS["tr_km_item_ar_grid"]->DetailEdit) {
					$GLOBALS["tr_km_item_ar_grid"]->CurrentMode = "edit";
					$GLOBALS["tr_km_item_ar_grid"]->CurrentAction = "gridedit";
...
// Create page object
if (!isset($tr_km_master_ar_edit)) $tr_km_master_ar_edit = new ctr_km_master_ar_edit();

// Page init
$tr_km_master_ar_edit->Page_Init();

// Page main
$tr_km_master_ar_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tr_km_master_ar_edit->Page_Render();
?>
...
var CurrentForm = ftr_km_master_aredit = new ew_Form("ftr_km_master_aredit", "edit");

// Validate form
ftr_km_master_aredit.Validate = function() {
...
ftr_km_master_aredit.Form_CustomValidate = 
...
ftr_km_master_aredit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
ftr_km_master_aredit.Lists["x_customer_id"] = {"LinkField":"x_customer_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_customer_name","","",""],"ParentFields":[],"ChildFields":["tr_km_item_ar x_customer_id"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tbl_customer"};
ftr_km_master_aredit.Lists["x_customer_id"].Data = "<?php echo $tr_km_master_ar_edit->customer_id->LookupFilterQuery(FALSE, "edit") ?>";
ftr_km_master_aredit.AutoSuggests["x_customer_id"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $tr_km_master_ar_edit->customer_id->LookupFilterQuery(TRUE, "edit"))) ?>;
ftr_km_master_aredit.Lists["x_km_type"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ftr_km_master_aredit.Lists["x_km_type"].Options = <?php echo json_encode($tr_km_master_ar_edit->km_type->Options()) ?>;
ftr_km_master_aredit.Lists["x_ret_number1"] = {"LinkField":"x_ret_number","Ajax":true,"AutoFill":true,"DisplayFields":["x_ret_number","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tr_ret_master"};
ftr_km_master_aredit.Lists["x_ret_number1"].Data = "<?php echo $tr_km_master_ar_edit->ret_number1->LookupFilterQuery(FALSE, "edit") ?>";
ftr_km_master_aredit.Lists["x_ret_number2"] = {"LinkField":"x_ret_number","Ajax":true,"AutoFill":true,"DisplayFields":["x_ret_number","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tr_ret_master"};
ftr_km_master_aredit.Lists["x_ret_number2"].Data = "<?php echo $tr_km_master_ar_edit->ret_number2->LookupFilterQuery(FALSE, "edit") ?>";
ftr_km_master_aredit.Lists["x_ret_number3"] = {"LinkField":"x_ret_number","Ajax":true,"AutoFill":true,"DisplayFields":["x_ret_number","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tr_ret_master"};
ftr_km_master_aredit.Lists["x_ret_number3"].Data = "<?php echo $tr_km_master_ar_edit->ret_number3->LookupFilterQuery(FALSE, "edit") ?>";
...
<?php $tr_km_master_ar_edit->ShowPageHeader(); ?>
<?php
$tr_km_master_ar_edit->ShowMessage();
?>
<form name="ftr_km_master_aredit" id="ftr_km_master_aredit" class="<?php echo $tr_km_master_ar_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($tr_km_master_ar_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tr_km_master_ar_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="tr_km_master_ar">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($tr_km_master_ar_edit->IsModal) ?>">
<div id="tpd_tr_km_master_aredit" class="ewCustomTemplate"></div>
<script id="tpm_tr_km_master_aredit" type="text/html">
<div id="ct_tr_km_master_ar_edit"><div class="col-sm-12">
	<div class="row">
		<div class="col-sm-5">
...
<?php if (!$tr_km_master_ar_edit->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($tr_km_master_ar_edit->IsMobileOrModal) { ?>
<div class="ewEditDiv hidden"><!-- page* -->
<?php } else { ?>
<table id="tbl_tr_km_master_aredit" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable hidden"><!-- table* -->
<?php } ?>
<?php if ($tr_km_master_ar->row_id->Visible) { // row_id ?>
<?php if ($tr_km_master_ar_edit->IsMobileOrModal) { ?>
	<div id="r_row_id" class="form-group">
		<label id="elh_tr_km_master_ar_row_id" class="<?php echo $tr_km_master_ar_edit->LeftColumnClass ?>"><script id="tpc_tr_km_master_ar_row_id" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->row_id->FldCaption() ?></span></script></label>
		<div class="<?php echo $tr_km_master_ar_edit->RightColumnClass ?>"><div<?php echo $tr_km_master_ar->row_id->CellAttributes() ?>>
<script id="tpx_tr_km_master_ar_row_id" class="tr_km_master_aredit" type="text/html">
<span id="el_tr_km_master_ar_row_id">
<span<?php echo $tr_km_master_ar->row_id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $tr_km_master_ar->row_id->EditValue ?></p></span>
</span>
</script>
<input type="hidden" data-table="tr_km_master_ar" data-field="x_row_id" name="x_row_id" id="x_row_id" value="<?php echo ew_HtmlEncode($tr_km_master_ar->row_id->CurrentValue) ?>">
<?php echo $tr_km_master_ar->row_id->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_row_id">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar_row_id"><script id="tpc_tr_km_master_ar_row_id" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->row_id->FldCaption() ?></span></script></span></td>
		<td<?php echo $tr_km_master_ar->row_id->CellAttributes() ?>>
<script id="tpx_tr_km_master_ar_row_id" class="tr_km_master_aredit" type="text/html">
<span id="el_tr_km_master_ar_row_id">
<span<?php echo $tr_km_master_ar->row_id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $tr_km_master_ar->row_id->EditValue ?></p></span>
...
<input type="hidden" data-table="tr_km_master_ar" data-field="x_row_id" name="x_row_id" id="x_row_id" value="<?php echo ew_HtmlEncode($tr_km_master_ar->row_id->CurrentValue) ?>">
<?php echo $tr_km_master_ar->row_id->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
...
<?php if ($tr_km_master_ar_edit->IsMobileOrModal) { ?>
	<div id="r_km_nomor" class="form-group">
		<label id="elh_tr_km_master_ar_km_nomor" for="x_km_nomor" class="<?php echo $tr_km_master_ar_edit->LeftColumnClass ?>"><script id="tpc_tr_km_master_ar_km_nomor" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->km_nomor->FldCaption() ?></span></script></label>
		<div class="<?php echo $tr_km_master_ar_edit->RightColumnClass ?>"><div<?php echo $tr_km_master_ar->km_nomor->CellAttributes() ?>>
<script id="tpx_tr_km_master_ar_km_nomor" class="tr_km_master_aredit" type="text/html">
...
<?php } else { ?>
	<tr id="r_km_nomor">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar_km_nomor"><script id="tpc_tr_km_master_ar_km_nomor" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->km_nomor->FldCaption() ?></span></script></span></td>
...
<?php if ($tr_km_master_ar_edit->IsMobileOrModal) { ?>
	<div id="r_km_tanggal" class="form-group">
		<label id="elh_tr_km_master_ar_km_tanggal" for="x_km_tanggal" class="<?php echo $tr_km_master_ar_edit->LeftColumnClass ?>"><script id="tpc_tr_km_master_ar_km_tanggal" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->km_tanggal->FldCaption() ?></span></script></label>
		<div class="<?php echo $tr_km_master_ar_edit->RightColumnClass ?>"><div<?php echo $tr_km_master_ar->km_tanggal->CellAttributes() ?>>
<script id="tpx_tr_km_master_ar_km_tanggal" class="tr_km_master_aredit" type="text/html">
...
<script type="text/html" class="tr_km_master_aredit_js">
ew_CreateDateTimePicker("ftr_km_master_aredit", "x_km_tanggal", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php echo $tr_km_master_ar->km_tanggal->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_km_tanggal">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar_km_tanggal"><script id="tpc_tr_km_master_ar_km_tanggal" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->km_tanggal->FldCaption() ?></span></script></span></td>
...
<?php if ($tr_km_master_ar_edit->IsMobileOrModal) { ?>
	<div id="r_customer_id" class="form-group">
		<label id="elh_tr_km_master_ar_customer_id" class="<?php echo $tr_km_master_ar_edit->LeftColumnClass ?>"><script id="tpc_tr_km_master_ar_customer_id" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->customer_id->FldCaption() ?></span></script></label>
		<div class="<?php echo $tr_km_master_ar_edit->RightColumnClass ?>"><div<?php echo $tr_km_master_ar->customer_id->CellAttributes() ?>>
<script id="tpx_tr_km_master_ar_customer_id" class="tr_km_master_aredit" type="text/html">
...
<script type="text/html" class="tr_km_master_aredit_js">
ftr_km_master_aredit.CreateAutoSuggest({"id":"x_customer_id","forceSelect":true});
</script>
<?php echo $tr_km_master_ar->customer_id->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_customer_id">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar_customer_id"><script id="tpc_tr_km_master_ar_customer_id" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->customer_id->FldCaption() ?></span></script></span></td>
...
<?php if ($tr_km_master_ar_edit->IsMobileOrModal) { ?>
	<div id="r_customer_name" class="form-group">
		<label id="elh_tr_km_master_ar_customer_name" for="x_customer_name" class="<?php echo $tr_km_master_ar_edit->LeftColumnClass ?>"><script id="tpc_tr_km_master_ar_customer_name" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->customer_name->FldCaption() ?></span></script></label>
		<div class="<?php echo $tr_km_master_ar_edit->RightColumnClass ?>"><div<?php echo $tr_km_master_ar->customer_name->CellAttributes() ?>>
<script id="tpx_tr_km_master_ar_customer_name" class="tr_km_master_aredit" type="text/html">
...
<?php } else { ?>
	<tr id="r_customer_name">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar_customer_name"><script id="tpc_tr_km_master_ar_customer_name" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->customer_name->FldCaption() ?></span></script></span></td>
...
<?php if ($tr_km_master_ar_edit->IsMobileOrModal) { ?>
	<div id="r_km_type" class="form-group">
		<label id="elh_tr_km_master_ar_km_type" class="<?php echo $tr_km_master_ar_edit->LeftColumnClass ?>"><script id="tpc_tr_km_master_ar_km_type" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->km_type->FldCaption() ?></span></script></label>
		<div class="<?php echo $tr_km_master_ar_edit->RightColumnClass ?>"><div<?php echo $tr_km_master_ar->km_type->CellAttributes() ?>>
<script id="tpx_tr_km_master_ar_km_type" class="tr_km_master_aredit" type="text/html">
...
<?php } else { ?>
	<tr id="r_km_type">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar_km_type"><script id="tpc_tr_km_master_ar_km_type" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->km_type->FldCaption() ?></span></script></span></td>
...
<?php if ($tr_km_master_ar_edit->IsMobileOrModal) { ?>
	<div id="r_km_acc" class="form-group">
		<label id="elh_tr_km_master_ar_km_acc" for="x_km_acc" class="<?php echo $tr_km_master_ar_edit->LeftColumnClass ?>"><script id="tpc_tr_km_master_ar_km_acc" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->km_acc->FldCaption() ?></span></script></label>
		<div class="<?php echo $tr_km_master_ar_edit->RightColumnClass ?>"><div<?php echo $tr_km_master_ar->km_acc->CellAttributes() ?>>
<script id="tpx_tr_km_master_ar_km_acc" class="tr_km_master_aredit" type="text/html">
...
<?php } else { ?>
	<tr id="r_km_acc">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar_km_acc"><script id="tpc_tr_km_master_ar_km_acc" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->km_acc->FldCaption() ?></span></script></span></td>
...
<?php if ($tr_km_master_ar_edit->IsMobileOrModal) { ?>
	<div id="r_cek_no" class="form-group">
		<label id="elh_tr_km_master_ar_cek_no" for="x_cek_no" class="<?php echo $tr_km_master_ar_edit->LeftColumnClass ?>"><script id="tpc_tr_km_master_ar_cek_no" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->cek_no->FldCaption() ?></span></script></label>
		<div class="<?php echo $tr_km_master_ar_edit->RightColumnClass ?>"><div<?php echo $tr_km_master_ar->cek_no->CellAttributes() ?>>
<script id="tpx_tr_km_master_ar_cek_no" class="tr_km_master_aredit" type="text/html">
...
<?php } else { ?>
	<tr id="r_cek_no">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar_cek_no"><script id="tpc_tr_km_master_ar_cek_no" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->cek_no->FldCaption() ?></span></script></span></td>
...
<?php if ($tr_km_master_ar_edit->IsMobileOrModal) { ?>
	<div id="r_tgl_jt" class="form-group">
		<label id="elh_tr_km_master_ar_tgl_jt" for="x_tgl_jt" class="<?php echo $tr_km_master_ar_edit->LeftColumnClass ?>"><script id="tpc_tr_km_master_ar_tgl_jt" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->tgl_jt->FldCaption() ?></span></script></label>
		<div class="<?php echo $tr_km_master_ar_edit->RightColumnClass ?>"><div<?php echo $tr_km_master_ar->tgl_jt->CellAttributes() ?>>
<script id="tpx_tr_km_master_ar_tgl_jt" class="tr_km_master_aredit" type="text/html">
...
<script type="text/html" class="tr_km_master_aredit_js">
ew_CreateDateTimePicker("ftr_km_master_aredit", "x_tgl_jt", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php echo $tr_km_master_ar->tgl_jt->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_tgl_jt">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar_tgl_jt"><script id="tpc_tr_km_master_ar_tgl_jt" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->tgl_jt->FldCaption() ?></span></script></span></td>
...
<?php if ($tr_km_master_ar_edit->IsMobileOrModal) { ?>
	<div id="r_cek_amt" class="form-group">
		<label id="elh_tr_km_master_ar_cek_amt" for="x_cek_amt" class="<?php echo $tr_km_master_ar_edit->LeftColumnClass ?>"><script id="tpc_tr_km_master_ar_cek_amt" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->cek_amt->FldCaption() ?></span></script></label>
		<div class="<?php echo $tr_km_master_ar_edit->RightColumnClass ?>"><div<?php echo $tr_km_master_ar->cek_amt->CellAttributes() ?>>
<script id="tpx_tr_km_master_ar_cek_amt" class="tr_km_master_aredit" type="text/html">
...
<?php } else { ?>
	<tr id="r_cek_amt">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar_cek_amt"><script id="tpc_tr_km_master_ar_cek_amt" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->cek_amt->FldCaption() ?></span></script></span></td>
...
<?php if ($tr_km_master_ar_edit->IsMobileOrModal) { ?>
	<div id="r_ret_number1" class="form-group">
		<label id="elh_tr_km_master_ar_ret_number1" for="x_ret_number1" class="<?php echo $tr_km_master_ar_edit->LeftColumnClass ?>"><script id="tpc_tr_km_master_ar_ret_number1" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->ret_number1->FldCaption() ?></span></script></label>
		<div class="<?php echo $tr_km_master_ar_edit->RightColumnClass ?>"><div<?php echo $tr_km_master_ar->ret_number1->CellAttributes() ?>>
<script id="tpx_tr_km_master_ar_ret_number1" class="tr_km_master_aredit" type="text/html">
...
<?php } else { ?>
	<tr id="r_ret_number1">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar_ret_number1"><script id="tpc_tr_km_master_ar_ret_number1" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->ret_number1->FldCaption() ?></span></script></span></td>
...
<?php if ($tr_km_master_ar_edit->IsMobileOrModal) { ?>
	<div id="r_ret_date1" class="form-group">
		<label id="elh_tr_km_master_ar_ret_date1" for="x_ret_date1" class="<?php echo $tr_km_master_ar_edit->LeftColumnClass ?>"><script id="tpc_tr_km_master_ar_ret_date1" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->ret_date1->FldCaption() ?></span></script></label>
		<div class="<?php echo $tr_km_master_ar_edit->RightColumnClass ?>"><div<?php echo $tr_km_master_ar->ret_date1->CellAttributes() ?>>
<script id="tpx_tr_km_master_ar_ret_date1" class="tr_km_master_aredit" type="text/html">
...
<script type="text/html" class="tr_km_master_aredit_js">
ew_CreateDateTimePicker("ftr_km_master_aredit", "x_ret_date1", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php echo $tr_km_master_ar->ret_date1->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_ret_date1">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar_ret_date1"><script id="tpc_tr_km_master_ar_ret_date1" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->ret_date1->FldCaption() ?></span></script></span></td>
...
<?php if ($tr_km_master_ar_edit->IsMobileOrModal) { ?>
	<div id="r_retur_amt1" class="form-group">
		<label id="elh_tr_km_master_ar_retur_amt1" for="x_retur_amt1" class="<?php echo $tr_km_master_ar_edit->LeftColumnClass ?>"><script id="tpc_tr_km_master_ar_retur_amt1" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->retur_amt1->FldCaption() ?></span></script></label>
		<div class="<?php echo $tr_km_master_ar_edit->RightColumnClass ?>"><div<?php echo $tr_km_master_ar->retur_amt1->CellAttributes() ?>>
<script id="tpx_tr_km_master_ar_retur_amt1" class="tr_km_master_aredit" type="text/html">
...
<?php } else { ?>
	<tr id="r_retur_amt1">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar_retur_amt1"><script id="tpc_tr_km_master_ar_retur_amt1" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->retur_amt1->FldCaption() ?></span></script></span></td>
...
<?php if ($tr_km_master_ar_edit->IsMobileOrModal) { ?>
	<div id="r_ret_number2" class="form-group">
		<label id="elh_tr_km_master_ar_ret_number2" for="x_ret_number2" class="<?php echo $tr_km_master_ar_edit->LeftColumnClass ?>"><script id="tpc_tr_km_master_ar_ret_number2" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->ret_number2->FldCaption() ?></span></script></label>
		<div class="<?php echo $tr_km_master_ar_edit->RightColumnClass ?>"><div<?php echo $tr_km_master_ar->ret_number2->CellAttributes() ?>>
<script id="tpx_tr_km_master_ar_ret_number2" class="tr_km_master_aredit" type="text/html">
...
<?php } else { ?>
	<tr id="r_ret_number2">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar_ret_number2"><script id="tpc_tr_km_master_ar_ret_number2" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->ret_number2->FldCaption() ?></span></script></span></td>
...
<?php if ($tr_km_master_ar_edit->IsMobileOrModal) { ?>
	<div id="r_ret_date2" class="form-group">
		<label id="elh_tr_km_master_ar_ret_date2" for="x_ret_date2" class="<?php echo $tr_km_master_ar_edit->LeftColumnClass ?>"><script id="tpc_tr_km_master_ar_ret_date2" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->ret_date2->FldCaption() ?></span></script></label>
		<div class="<?php echo $tr_km_master_ar_edit->RightColumnClass ?>"><div<?php echo $tr_km_master_ar->ret_date2->CellAttributes() ?>>
<script id="tpx_tr_km_master_ar_ret_date2" class="tr_km_master_aredit" type="text/html">
...
<script type="text/html" class="tr_km_master_aredit_js">
ew_CreateDateTimePicker("ftr_km_master_aredit", "x_ret_date2", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php echo $tr_km_master_ar->ret_date2->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_ret_date2">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar_ret_date2"><script id="tpc_tr_km_master_ar_ret_date2" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->ret_date2->FldCaption() ?></span></script></span></td>
...
<?php if ($tr_km_master_ar_edit->IsMobileOrModal) { ?>
	<div id="r_retur_amt2" class="form-group">
		<label id="elh_tr_km_master_ar_retur_amt2" for="x_retur_amt2" class="<?php echo $tr_km_master_ar_edit->LeftColumnClass ?>"><script id="tpc_tr_km_master_ar_retur_amt2" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->retur_amt2->FldCaption() ?></span></script></label>
		<div class="<?php echo $tr_km_master_ar_edit->RightColumnClass ?>"><div<?php echo $tr_km_master_ar->retur_amt2->CellAttributes() ?>>
<script id="tpx_tr_km_master_ar_retur_amt2" class="tr_km_master_aredit" type="text/html">
...
<?php } else { ?>
	<tr id="r_retur_amt2">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar_retur_amt2"><script id="tpc_tr_km_master_ar_retur_amt2" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->retur_amt2->FldCaption() ?></span></script></span></td>
...
<?php if ($tr_km_master_ar_edit->IsMobileOrModal) { ?>
	<div id="r_ret_number3" class="form-group">
		<label id="elh_tr_km_master_ar_ret_number3" for="x_ret_number3" class="<?php echo $tr_km_master_ar_edit->LeftColumnClass ?>"><script id="tpc_tr_km_master_ar_ret_number3" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->ret_number3->FldCaption() ?></span></script></label>
		<div class="<?php echo $tr_km_master_ar_edit->RightColumnClass ?>"><div<?php echo $tr_km_master_ar->ret_number3->CellAttributes() ?>>
<script id="tpx_tr_km_master_ar_ret_number3" class="tr_km_master_aredit" type="text/html">
...
<?php } else { ?>
	<tr id="r_ret_number3">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar_ret_number3"><script id="tpc_tr_km_master_ar_ret_number3" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->ret_number3->FldCaption() ?></span></script></span></td>
...
<?php if ($tr_km_master_ar_edit->IsMobileOrModal) { ?>
	<div id="r_ret_date3" class="form-group">
		<label id="elh_tr_km_master_ar_ret_date3" for="x_ret_date3" class="<?php echo $tr_km_master_ar_edit->LeftColumnClass ?>"><script id="tpc_tr_km_master_ar_ret_date3" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->ret_date3->FldCaption() ?></span></script></label>
		<div class="<?php echo $tr_km_master_ar_edit->RightColumnClass ?>"><div<?php echo $tr_km_master_ar->ret_date3->CellAttributes() ?>>
<script id="tpx_tr_km_master_ar_ret_date3" class="tr_km_master_aredit" type="text/html">
...
<script type="text/html" class="tr_km_master_aredit_js">
ew_CreateDateTimePicker("ftr_km_master_aredit", "x_ret_date3", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php echo $tr_km_master_ar->ret_date3->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_ret_date3">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar_ret_date3"><script id="tpc_tr_km_master_ar_ret_date3" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->ret_date3->FldCaption() ?></span></script></span></td>
...
<?php if ($tr_km_master_ar_edit->IsMobileOrModal) { ?>
	<div id="r_retur_amt3" class="form-group">
		<label id="elh_tr_km_master_ar_retur_amt3" for="x_retur_amt3" class="<?php echo $tr_km_master_ar_edit->LeftColumnClass ?>"><script id="tpc_tr_km_master_ar_retur_amt3" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->retur_amt3->FldCaption() ?></span></script></label>
		<div class="<?php echo $tr_km_master_ar_edit->RightColumnClass ?>"><div<?php echo $tr_km_master_ar->retur_amt3->CellAttributes() ?>>
<script id="tpx_tr_km_master_ar_retur_amt3" class="tr_km_master_aredit" type="text/html">
...
<?php } else { ?>
	<tr id="r_retur_amt3">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar_retur_amt3"><script id="tpc_tr_km_master_ar_retur_amt3" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->retur_amt3->FldCaption() ?></span></script></span></td>
...
<?php if ($tr_km_master_ar_edit->IsMobileOrModal) { ?>
	<div id="r_tunai_amt" class="form-group">
		<label id="elh_tr_km_master_ar_tunai_amt" for="x_tunai_amt" class="<?php echo $tr_km_master_ar_edit->LeftColumnClass ?>"><script id="tpc_tr_km_master_ar_tunai_amt" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->tunai_amt->FldCaption() ?></span></script></label>
		<div class="<?php echo $tr_km_master_ar_edit->RightColumnClass ?>"><div<?php echo $tr_km_master_ar->tunai_amt->CellAttributes() ?>>
<script id="tpx_tr_km_master_ar_tunai_amt" class="tr_km_master_aredit" type="text/html">
...
<?php } else { ?>
	<tr id="r_tunai_amt">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar_tunai_amt"><script id="tpc_tr_km_master_ar_tunai_amt" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->tunai_amt->FldCaption() ?></span></script></span></td>
...
<?php if ($tr_km_master_ar_edit->IsMobileOrModal) { ?>
	<div id="r_dp_amt" class="form-group">
		<label id="elh_tr_km_master_ar_dp_amt" for="x_dp_amt" class="<?php echo $tr_km_master_ar_edit->LeftColumnClass ?>"><script id="tpc_tr_km_master_ar_dp_amt" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->dp_amt->FldCaption() ?></span></script></label>
		<div class="<?php echo $tr_km_master_ar_edit->RightColumnClass ?>"><div<?php echo $tr_km_master_ar->dp_amt->CellAttributes() ?>>
<script id="tpx_tr_km_master_ar_dp_amt" class="tr_km_master_aredit" type="text/html">
...
<?php } else { ?>
	<tr id="r_dp_amt">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar_dp_amt"><script id="tpc_tr_km_master_ar_dp_amt" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->dp_amt->FldCaption() ?></span></script></span></td>
...
<?php if ($tr_km_master_ar_edit->IsMobileOrModal) { ?>
	<div id="r_km_amt" class="form-group">
		<label id="elh_tr_km_master_ar_km_amt" for="x_km_amt" class="<?php echo $tr_km_master_ar_edit->LeftColumnClass ?>"><script id="tpc_tr_km_master_ar_km_amt" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->km_amt->FldCaption() ?></span></script></label>
		<div class="<?php echo $tr_km_master_ar_edit->RightColumnClass ?>"><div<?php echo $tr_km_master_ar->km_amt->CellAttributes() ?>>
<script id="tpx_tr_km_master_ar_km_amt" class="tr_km_master_aredit" type="text/html">
...
<?php } else { ?>
	<tr id="r_km_amt">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar_km_amt"><script id="tpc_tr_km_master_ar_km_amt" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->km_amt->FldCaption() ?></span></script></span></td>
...
<?php if ($tr_km_master_ar_edit->IsMobileOrModal) { ?>
	<div id="r_km_notes" class="form-group">
		<label id="elh_tr_km_master_ar_km_notes" for="x_km_notes" class="<?php echo $tr_km_master_ar_edit->LeftColumnClass ?>"><script id="tpc_tr_km_master_ar_km_notes" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->km_notes->FldCaption() ?></span></script></label>
		<div class="<?php echo $tr_km_master_ar_edit->RightColumnClass ?>"><div<?php echo $tr_km_master_ar->km_notes->CellAttributes() ?>>
<script id="tpx_tr_km_master_ar_km_notes" class="tr_km_master_aredit" type="text/html">
...
<?php } else { ?>
	<tr id="r_km_notes">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar_km_notes"><script id="tpc_tr_km_master_ar_km_notes" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->km_notes->FldCaption() ?></span></script></span></td>
...
<?php if ($tr_km_master_ar_edit->IsMobileOrModal) { ?>
	<div id="r_kas_amt" class="form-group">
		<label id="elh_tr_km_master_ar_kas_amt" for="x_kas_amt" class="<?php echo $tr_km_master_ar_edit->LeftColumnClass ?>"><script id="tpc_tr_km_master_ar_kas_amt" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->kas_amt->FldCaption() ?></span></script></label>
		<div class="<?php echo $tr_km_master_ar_edit->RightColumnClass ?>"><div<?php echo $tr_km_master_ar->kas_amt->CellAttributes() ?>>
<script id="tpx_tr_km_master_ar_kas_amt" class="tr_km_master_aredit" type="text/html">
...
<?php } else { ?>
	<tr id="r_kas_amt">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar_kas_amt"><script id="tpc_tr_km_master_ar_kas_amt" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->kas_amt->FldCaption() ?></span></script></span></td>
...
<?php if ($tr_km_master_ar_edit->IsMobileOrModal) { ?>
	<div id="r_kode_depo" class="form-group">
		<label id="elh_tr_km_master_ar_kode_depo" for="x_kode_depo" class="<?php echo $tr_km_master_ar_edit->LeftColumnClass ?>"><script id="tpc_tr_km_master_ar_kode_depo" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->kode_depo->FldCaption() ?></span></script></label>
		<div class="<?php echo $tr_km_master_ar_edit->RightColumnClass ?>"><div<?php echo $tr_km_master_ar->kode_depo->CellAttributes() ?>>
<script id="tpx_tr_km_master_ar_kode_depo" class="tr_km_master_aredit" type="text/html">
...
<?php } else { ?>
	<tr id="r_kode_depo">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar_kode_depo"><script id="tpc_tr_km_master_ar_kode_depo" class="tr_km_master_aredit" type="text/html"><span><?php echo $tr_km_master_ar->kode_depo->FldCaption() ?></span></script></span></td>
...
<?php } ?>
<?php
	if (in_array("tr_km_item_ar", explode(",", $tr_km_master_ar->getCurrentDetailTable())) && $tr_km_item_ar->DetailEdit) {
?>
...
<?php } ?>
<?php if (!$tr_km_master_ar_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $tr_km_master_ar_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $tr_km_master_ar_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
ew_ApplyTemplate("tpd_tr_km_master_aredit", "tpm_tr_km_master_aredit", "tr_km_master_aredit", "<?php echo $tr_km_master_ar->CustomExport ?>", ewVar.templateData.rows[0]);
jQuery("script.tr_km_master_aredit_js").each(function(){ew_AddScript(this.text);});
</script>
<script type="text/javascript">
ftr_km_master_aredit.Init();
</script>
<?php
$tr_km_master_ar_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$tr_km_master_ar_edit->Page_Terminate();
?>
