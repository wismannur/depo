...
$tr_pb_item_grid = NULL; // Initialize page object first

class ctr_pb_item_grid extends ctr_pb_item {
	...
	// Page object name
	var $PageObjName = 'tr_pb_item_grid';

	// Grid form hidden field names
	var $FormName = 'ftr_pb_itemgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["tr_pb_item"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function SetupMasterParms() {
		...
		if ($sMasterTblVar == "tr_pb_master") {
			...
			if ($GLOBALS["tr_pb_master"]->EventCancelled) $this->EventCancelled = TRUE;
		}
