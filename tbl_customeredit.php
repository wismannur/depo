...
class ctbl_customer_edit extends ctbl_customer {
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// customer_code
			$this->customer_code->SetDbValueDef($rsnew, $this->customer_code->CurrentValue, NULL, $this->customer_code->ReadOnly);

			// customer_group
			$this->customer_group->SetDbValueDef($rsnew, $this->customer_group->CurrentValue, NULL, $this->customer_group->ReadOnly);
			...
			// ar_acc
			$this->ar_acc->SetDbValueDef($rsnew, $this->ar_acc->CurrentValue, NULL, $this->ar_acc->ReadOnly);
			...
			// credit_max
			$this->credit_max->SetDbValueDef($rsnew, $this->credit_max->CurrentValue, NULL, $this->credit_max->ReadOnly);

			// invoice_max
			$this->invoice_max->SetDbValueDef($rsnew, $this->invoice_max->CurrentValue, NULL, $this->invoice_max->ReadOnly);
	...
	function GetRowHash(&$rs) {
		if (!$rs)
			return "";
		$sHash = "";
		$sHash .= ew_GetFldHash($rs->fields('customer_code')); // customer_code
		$sHash .= ew_GetFldHash($rs->fields('customer_group')); // customer_group
		$sHash .= ew_GetFldHash($rs->fields('customer_name')); // customer_name
		$sHash .= ew_GetFldHash($rs->fields('contact_name')); // contact_name
		$sHash .= ew_GetFldHash($rs->fields('address1')); // address1
		$sHash .= ew_GetFldHash($rs->fields('address2')); // address2
		$sHash .= ew_GetFldHash($rs->fields('address3')); // address3
		$sHash .= ew_GetFldHash($rs->fields('phone')); // phone
		$sHash .= ew_GetFldHash($rs->fields('fax')); // fax
		$sHash .= ew_GetFldHash($rs->fields('wilayah_id')); // wilayah_id
		$sHash .= ew_GetFldHash($rs->fields('subwil_id')); // subwil_id
		$sHash .= ew_GetFldHash($rs->fields('area_id')); // area_id
		$sHash .= ew_GetFldHash($rs->fields('sales_id')); // sales_id
		$sHash .= ew_GetFldHash($rs->fields('due_day')); // due_day
		$sHash .= ew_GetFldHash($rs->fields('ar_acc')); // ar_acc
		$sHash .= ew_GetFldHash($rs->fields('npwp')); // npwp
		$sHash .= ew_GetFldHash($rs->fields('discount')); // discount
		$sHash .= ew_GetFldHash($rs->fields('credit_max')); // credit_max
		$sHash .= ew_GetFldHash($rs->fields('invoice_max')); // invoice_max
		return md5($sHash);
	}
...
ftbl_customeredit.Lists["x_customer_group"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ftbl_customeredit.Lists["x_customer_group"].Options = <?php echo json_encode($tbl_customer_edit->customer_group->Options()) ?>;
ftbl_customeredit.Lists["x_wilayah_id"] = {"LinkField":"x_wilayah_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_wilayah","","",""],"ParentFields":[],"ChildFields":["x_subwil_id"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tbl_wilayah"};
ftbl_customeredit.Lists["x_wilayah_id"].Data = "<?php echo $tbl_customer_edit->wilayah_id->LookupFilterQuery(FALSE, "edit") ?>";
ftbl_customeredit.Lists["x_subwil_id"] = {"LinkField":"x_sub_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_sub_wilayah","","",""],"ParentFields":["x_wilayah_id"],"ChildFields":["x_area_id"],"FilterFields":["x_wilayah_id"],"Options":[],"Template":"","LinkTable":"tbl_subwilayah"};
ftbl_customeredit.Lists["x_subwil_id"].Data = "<?php echo $tbl_customer_edit->subwil_id->LookupFilterQuery(FALSE, "edit") ?>";
ftbl_customeredit.Lists["x_area_id"] = {"LinkField":"x_area_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_area_name","","",""],"ParentFields":["x_subwil_id"],"ChildFields":[],"FilterFields":["x_subwil_id"],"Options":[],"Template":"","LinkTable":"tbl_callarea"};
ftbl_customeredit.Lists["x_area_id"].Data = "<?php echo $tbl_customer_edit->area_id->LookupFilterQuery(FALSE, "edit") ?>";
ftbl_customeredit.Lists["x_sales_id"] = {"LinkField":"x_sales_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_sales_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tbl_salesman"};
ftbl_customeredit.Lists["x_sales_id"].Data = "<?php echo $tbl_customer_edit->sales_id->LookupFilterQuery(FALSE, "edit") ?>";
...
<input type="hidden" name="k_hash" id="k_hash" value="<?php echo $tbl_customer_edit->HashValue ?>">
<?php if ($tbl_customer->UpdateConflict == "U") { // Record already updated by other user ?>
...
<?php if (!$tbl_customer_edit->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($tbl_customer_edit->IsMobileOrModal) { ?>
<div class="ewEditDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_tbl_customeredit" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
<?php if ($tbl_customer->customer_code->Visible) { // customer_code ?>
<?php if ($tbl_customer_edit->IsMobileOrModal) { ?>
	<div id="r_customer_code" class="form-group">
		<label id="elh_tbl_customer_customer_code" for="x_customer_code" class="<?php echo $tbl_customer_edit->LeftColumnClass ?>"><?php echo $tbl_customer->customer_code->FldCaption() ?></label>
		<div class="<?php echo $tbl_customer_edit->RightColumnClass ?>"><div<?php echo $tbl_customer->customer_code->CellAttributes() ?>>
...
<?php if ($tbl_customer_edit->IsMobileOrModal) { ?>
	<div id="r_customer_group" class="form-group">
		<label id="elh_tbl_customer_customer_group" for="x_customer_group" class="<?php echo $tbl_customer_edit->LeftColumnClass ?>"><?php echo $tbl_customer->customer_group->FldCaption() ?></label>
		<div class="<?php echo $tbl_customer_edit->RightColumnClass ?>"><div<?php echo $tbl_customer->customer_group->CellAttributes() ?>>
...
<?php if ($tbl_customer_edit->IsMobileOrModal) { ?>
	<div id="r_customer_name" class="form-group">
		<label id="elh_tbl_customer_customer_name" for="x_customer_name" class="<?php echo $tbl_customer_edit->LeftColumnClass ?>"><?php echo $tbl_customer->customer_name->FldCaption() ?></label>
		<div class="<?php echo $tbl_customer_edit->RightColumnClass ?>"><div<?php echo $tbl_customer->customer_name->CellAttributes() ?>>
...
<?php if ($tbl_customer_edit->IsMobileOrModal) { ?>
	<div id="r_contact_name" class="form-group">
		<label id="elh_tbl_customer_contact_name" for="x_contact_name" class="<?php echo $tbl_customer_edit->LeftColumnClass ?>"><?php echo $tbl_customer->contact_name->FldCaption() ?></label>
		<div class="<?php echo $tbl_customer_edit->RightColumnClass ?>"><div<?php echo $tbl_customer->contact_name->CellAttributes() ?>>
...
<?php if ($tbl_customer_edit->IsMobileOrModal) { ?>
	<div id="r_address1" class="form-group">
		<label id="elh_tbl_customer_address1" for="x_address1" class="<?php echo $tbl_customer_edit->LeftColumnClass ?>"><?php echo $tbl_customer->address1->FldCaption() ?></label>
		<div class="<?php echo $tbl_customer_edit->RightColumnClass ?>"><div<?php echo $tbl_customer->address1->CellAttributes() ?>>
...
<?php if ($tbl_customer_edit->IsMobileOrModal) { ?>
	<div id="r_address2" class="form-group">
		<label id="elh_tbl_customer_address2" for="x_address2" class="<?php echo $tbl_customer_edit->LeftColumnClass ?>"><?php echo $tbl_customer->address2->FldCaption() ?></label>
		<div class="<?php echo $tbl_customer_edit->RightColumnClass ?>"><div<?php echo $tbl_customer->address2->CellAttributes() ?>>
...
<?php if ($tbl_customer_edit->IsMobileOrModal) { ?>
	<div id="r_address3" class="form-group">
		<label id="elh_tbl_customer_address3" for="x_address3" class="<?php echo $tbl_customer_edit->LeftColumnClass ?>"><?php echo $tbl_customer->address3->FldCaption() ?></label>
		<div class="<?php echo $tbl_customer_edit->RightColumnClass ?>"><div<?php echo $tbl_customer->address3->CellAttributes() ?>>
...
<?php if ($tbl_customer_edit->IsMobileOrModal) { ?>
	<div id="r_phone" class="form-group">
		<label id="elh_tbl_customer_phone" for="x_phone" class="<?php echo $tbl_customer_edit->LeftColumnClass ?>"><?php echo $tbl_customer->phone->FldCaption() ?></label>
		<div class="<?php echo $tbl_customer_edit->RightColumnClass ?>"><div<?php echo $tbl_customer->phone->CellAttributes() ?>>
...
<?php if ($tbl_customer_edit->IsMobileOrModal) { ?>
	<div id="r_fax" class="form-group">
		<label id="elh_tbl_customer_fax" for="x_fax" class="<?php echo $tbl_customer_edit->LeftColumnClass ?>"><?php echo $tbl_customer->fax->FldCaption() ?></label>
		<div class="<?php echo $tbl_customer_edit->RightColumnClass ?>"><div<?php echo $tbl_customer->fax->CellAttributes() ?>>
...
<?php if ($tbl_customer_edit->IsMobileOrModal) { ?>
	<div id="r_wilayah_id" class="form-group">
		<label id="elh_tbl_customer_wilayah_id" for="x_wilayah_id" class="<?php echo $tbl_customer_edit->LeftColumnClass ?>"><?php echo $tbl_customer->wilayah_id->FldCaption() ?></label>
		<div class="<?php echo $tbl_customer_edit->RightColumnClass ?>"><div<?php echo $tbl_customer->wilayah_id->CellAttributes() ?>>
...
<?php if ($tbl_customer_edit->IsMobileOrModal) { ?>
	<div id="r_subwil_id" class="form-group">
		<label id="elh_tbl_customer_subwil_id" for="x_subwil_id" class="<?php echo $tbl_customer_edit->LeftColumnClass ?>"><?php echo $tbl_customer->subwil_id->FldCaption() ?></label>
		<div class="<?php echo $tbl_customer_edit->RightColumnClass ?>"><div<?php echo $tbl_customer->subwil_id->CellAttributes() ?>>
...
<?php if ($tbl_customer_edit->IsMobileOrModal) { ?>
	<div id="r_area_id" class="form-group">
		<label id="elh_tbl_customer_area_id" for="x_area_id" class="<?php echo $tbl_customer_edit->LeftColumnClass ?>"><?php echo $tbl_customer->area_id->FldCaption() ?></label>
		<div class="<?php echo $tbl_customer_edit->RightColumnClass ?>"><div<?php echo $tbl_customer->area_id->CellAttributes() ?>>
...
<?php if ($tbl_customer_edit->IsMobileOrModal) { ?>
	<div id="r_sales_id" class="form-group">
		<label id="elh_tbl_customer_sales_id" for="x_sales_id" class="<?php echo $tbl_customer_edit->LeftColumnClass ?>"><?php echo $tbl_customer->sales_id->FldCaption() ?></label>
		<div class="<?php echo $tbl_customer_edit->RightColumnClass ?>"><div<?php echo $tbl_customer->sales_id->CellAttributes() ?>>
...
<?php if ($tbl_customer_edit->IsMobileOrModal) { ?>
	<div id="r_due_day" class="form-group">
		<label id="elh_tbl_customer_due_day" for="x_due_day" class="<?php echo $tbl_customer_edit->LeftColumnClass ?>"><?php echo $tbl_customer->due_day->FldCaption() ?></label>
		<div class="<?php echo $tbl_customer_edit->RightColumnClass ?>"><div<?php echo $tbl_customer->due_day->CellAttributes() ?>>
...
<?php if ($tbl_customer_edit->IsMobileOrModal) { ?>
	<div id="r_ar_acc" class="form-group">
		<label id="elh_tbl_customer_ar_acc" for="x_ar_acc" class="<?php echo $tbl_customer_edit->LeftColumnClass ?>"><?php echo $tbl_customer->ar_acc->FldCaption() ?></label>
		<div class="<?php echo $tbl_customer_edit->RightColumnClass ?>"><div<?php echo $tbl_customer->ar_acc->CellAttributes() ?>>
...
<?php if ($tbl_customer_edit->IsMobileOrModal) { ?>
	<div id="r_npwp" class="form-group">
		<label id="elh_tbl_customer_npwp" for="x_npwp" class="<?php echo $tbl_customer_edit->LeftColumnClass ?>"><?php echo $tbl_customer->npwp->FldCaption() ?></label>
		<div class="<?php echo $tbl_customer_edit->RightColumnClass ?>"><div<?php echo $tbl_customer->npwp->CellAttributes() ?>>
...
<?php if ($tbl_customer_edit->IsMobileOrModal) { ?>
	<div id="r_discount" class="form-group">
		<label id="elh_tbl_customer_discount" for="x_discount" class="<?php echo $tbl_customer_edit->LeftColumnClass ?>"><?php echo $tbl_customer->discount->FldCaption() ?></label>
		<div class="<?php echo $tbl_customer_edit->RightColumnClass ?>"><div<?php echo $tbl_customer->discount->CellAttributes() ?>>
...
<?php if ($tbl_customer_edit->IsMobileOrModal) { ?>
	<div id="r_credit_max" class="form-group">
		<label id="elh_tbl_customer_credit_max" for="x_credit_max" class="<?php echo $tbl_customer_edit->LeftColumnClass ?>"><?php echo $tbl_customer->credit_max->FldCaption() ?></label>
		<div class="<?php echo $tbl_customer_edit->RightColumnClass ?>"><div<?php echo $tbl_customer->credit_max->CellAttributes() ?>>
...
<?php if ($tbl_customer_edit->IsMobileOrModal) { ?>
	<div id="r_invoice_max" class="form-group">
		<label id="elh_tbl_customer_invoice_max" for="x_invoice_max" class="<?php echo $tbl_customer_edit->LeftColumnClass ?>"><?php echo $tbl_customer->invoice_max->FldCaption() ?></label>
		<div class="<?php echo $tbl_customer_edit->RightColumnClass ?>"><div<?php echo $tbl_customer->invoice_max->CellAttributes() ?>>
...
<?php } ?>
<input type="hidden" data-table="tbl_customer" data-field="x_customer_id" name="x_customer_id" id="x_customer_id" value="<?php echo ew_HtmlEncode($tbl_customer->customer_id->CurrentValue) ?>">
