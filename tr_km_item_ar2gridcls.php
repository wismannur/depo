...
$tr_km_item_ar2_grid = NULL; // Initialize page object first

class ctr_km_item_ar2_grid extends ctr_km_item_ar2 {
	...
	// Page object name
	var $PageObjName = 'tr_km_item_ar2_grid';

	// Grid form hidden field names
	var $FormName = 'ftr_km_item_ar2grid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["tr_km_item_ar2"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function SetupMasterParms() {
		...
		if ($sMasterTblVar == "tr_km_master_ar2") {
			...
			if ($GLOBALS["tr_km_master_ar2"]->EventCancelled) $this->EventCancelled = TRUE;
		}
