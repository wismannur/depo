...
$tbl_callarea_edit = NULL; // Initialize page object first

class ctbl_callarea_edit extends ctbl_callarea {
	...
	// Page object name
	var $PageObjName = 'tbl_callarea_edit';
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// area_name
			$this->area_name->SetDbValueDef($rsnew, $this->area_name->CurrentValue, NULL, $this->area_name->ReadOnly);
...
// Create page object
if (!isset($tbl_callarea_edit)) $tbl_callarea_edit = new ctbl_callarea_edit();

// Page init
$tbl_callarea_edit->Page_Init();

// Page main
$tbl_callarea_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tbl_callarea_edit->Page_Render();
?>
...
var CurrentForm = ftbl_callareaedit = new ew_Form("ftbl_callareaedit", "edit");

// Validate form
ftbl_callareaedit.Validate = function() {
...
ftbl_callareaedit.Form_CustomValidate = 
...
ftbl_callareaedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $tbl_callarea_edit->ShowPageHeader(); ?>
<?php
$tbl_callarea_edit->ShowMessage();
?>
<form name="ftbl_callareaedit" id="ftbl_callareaedit" class="<?php echo $tbl_callarea_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($tbl_callarea_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tbl_callarea_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="tbl_callarea">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($tbl_callarea_edit->IsModal) ?>">
<?php if (!$tbl_callarea_edit->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($tbl_callarea_edit->IsMobileOrModal) { ?>
<div class="ewEditDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_tbl_callareaedit" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
<?php if ($tbl_callarea->area_id->Visible) { // area_id ?>
<?php if ($tbl_callarea_edit->IsMobileOrModal) { ?>
	<div id="r_area_id" class="form-group">
		<label id="elh_tbl_callarea_area_id" class="<?php echo $tbl_callarea_edit->LeftColumnClass ?>"><?php echo $tbl_callarea->area_id->FldCaption() ?></label>
		<div class="<?php echo $tbl_callarea_edit->RightColumnClass ?>"><div<?php echo $tbl_callarea->area_id->CellAttributes() ?>>
<span id="el_tbl_callarea_area_id">
<span<?php echo $tbl_callarea->area_id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $tbl_callarea->area_id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="tbl_callarea" data-field="x_area_id" name="x_area_id" id="x_area_id" value="<?php echo ew_HtmlEncode($tbl_callarea->area_id->CurrentValue) ?>">
<?php echo $tbl_callarea->area_id->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_area_id">
		<td class="col-sm-2"><span id="elh_tbl_callarea_area_id"><?php echo $tbl_callarea->area_id->FldCaption() ?></span></td>
...
<input type="hidden" data-table="tbl_callarea" data-field="x_area_id" name="x_area_id" id="x_area_id" value="<?php echo ew_HtmlEncode($tbl_callarea->area_id->CurrentValue) ?>">
<?php echo $tbl_callarea->area_id->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
...
<?php if ($tbl_callarea_edit->IsMobileOrModal) { ?>
	<div id="r_area_name" class="form-group">
		<label id="elh_tbl_callarea_area_name" for="x_area_name" class="<?php echo $tbl_callarea_edit->LeftColumnClass ?>"><?php echo $tbl_callarea->area_name->FldCaption() ?></label>
		<div class="<?php echo $tbl_callarea_edit->RightColumnClass ?>"><div<?php echo $tbl_callarea->area_name->CellAttributes() ?>>
...
<?php if ($tbl_callarea_edit->IsMobileOrModal) { ?>
	<div id="r_subwil_id" class="form-group">
		<label id="elh_tbl_callarea_subwil_id" for="x_subwil_id" class="<?php echo $tbl_callarea_edit->LeftColumnClass ?>"><?php echo $tbl_callarea->subwil_id->FldCaption() ?></label>
		<div class="<?php echo $tbl_callarea_edit->RightColumnClass ?>"><div<?php echo $tbl_callarea->subwil_id->CellAttributes() ?>>
...
<?php if ($tbl_callarea_edit->IsMobileOrModal) { ?>
	<div id="r_wilayah_id" class="form-group">
		<label id="elh_tbl_callarea_wilayah_id" for="x_wilayah_id" class="<?php echo $tbl_callarea_edit->LeftColumnClass ?>"><?php echo $tbl_callarea->wilayah_id->FldCaption() ?></label>
		<div class="<?php echo $tbl_callarea_edit->RightColumnClass ?>"><div<?php echo $tbl_callarea->wilayah_id->CellAttributes() ?>>
...
<?php } ?>
<?php if (!$tbl_callarea_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $tbl_callarea_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $tbl_callarea_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
ftbl_callareaedit.Init();
</script>
<?php
$tbl_callarea_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$tbl_callarea_edit->Page_Terminate();
?>
