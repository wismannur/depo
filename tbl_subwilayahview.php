...
$tbl_subwilayah_view = NULL; // Initialize page object first

class ctbl_subwilayah_view extends ctbl_subwilayah {
	...
	// Page object name
	var $PageObjName = 'tbl_subwilayah_view';
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["sub_id"] <> "") {
			$this->RecKey["sub_id"] = $_GET["sub_id"];
			$KeyUrl .= "&amp;sub_id=" . urlencode($this->RecKey["sub_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["sub_id"] <> "") {
				...
				$this->RecKey["sub_id"] = $this->sub_id->QueryStringValue;
			} elseif (@$_POST["sub_id"] <> "") {
				$this->sub_id->setFormValue($_POST["sub_id"]);
				$this->RecKey["sub_id"] = $this->sub_id->FormValue;
			} else {
				$sReturnUrl = "tbl_subwilayahlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "tbl_subwilayahlist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "tbl_subwilayahlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($tbl_subwilayah_view)) $tbl_subwilayah_view = new ctbl_subwilayah_view();

// Page init
$tbl_subwilayah_view->Page_Init();

// Page main
$tbl_subwilayah_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tbl_subwilayah_view->Page_Render();
?>
...
var CurrentForm = ftbl_subwilayahview = new ew_Form("ftbl_subwilayahview", "view");

// Form_CustomValidate event
ftbl_subwilayahview.Form_CustomValidate = 
...
ftbl_subwilayahview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<div class="ewToolbar">
<?php $tbl_subwilayah_view->ExportOptions->Render("body") ?>
<?php
	foreach ($tbl_subwilayah_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php $tbl_subwilayah_view->ShowPageHeader(); ?>
<?php
$tbl_subwilayah_view->ShowMessage();
?>
<form name="ftbl_subwilayahview" id="ftbl_subwilayahview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($tbl_subwilayah_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tbl_subwilayah_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="tbl_subwilayah">
<input type="hidden" name="modal" value="<?php echo intval($tbl_subwilayah_view->IsModal) ?>">
...
<?php if ($tbl_subwilayah->sub_id->Visible) { // sub_id ?>
	<tr id="r_sub_id">
		...
		<td data-name="sub_id"<?php echo $tbl_subwilayah->sub_id->CellAttributes() ?>>
<span id="el_tbl_subwilayah_sub_id">
<span<?php echo $tbl_subwilayah->sub_id->ViewAttributes() ?>>
<?php echo $tbl_subwilayah->sub_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbl_subwilayah->nama_sub_wilayah->Visible) { // nama_sub_wilayah ?>
	<tr id="r_nama_sub_wilayah">
		...
		<td data-name="nama_sub_wilayah"<?php echo $tbl_subwilayah->nama_sub_wilayah->CellAttributes() ?>>
<span id="el_tbl_subwilayah_nama_sub_wilayah">
<span<?php echo $tbl_subwilayah->nama_sub_wilayah->ViewAttributes() ?>>
<?php echo $tbl_subwilayah->nama_sub_wilayah->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbl_subwilayah->cakupan_area->Visible) { // cakupan_area ?>
	<tr id="r_cakupan_area">
		...
		<td data-name="cakupan_area"<?php echo $tbl_subwilayah->cakupan_area->CellAttributes() ?>>
<span id="el_tbl_subwilayah_cakupan_area">
<span<?php echo $tbl_subwilayah->cakupan_area->ViewAttributes() ?>>
<?php echo $tbl_subwilayah->cakupan_area->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbl_subwilayah->wilayah_id->Visible) { // wilayah_id ?>
	<tr id="r_wilayah_id">
		...
		<td data-name="wilayah_id"<?php echo $tbl_subwilayah->wilayah_id->CellAttributes() ?>>
<span id="el_tbl_subwilayah_wilayah_id">
<span<?php echo $tbl_subwilayah->wilayah_id->ViewAttributes() ?>>
<?php echo $tbl_subwilayah->wilayah_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
ftbl_subwilayahview.Init();
</script>
<?php
$tbl_subwilayah_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$tbl_subwilayah_view->Page_Terminate();
?>
