...
//
// Table class for tbl_bank
//
class ctbl_bank extends cTable {
	var $bank_id;
	var $no_rekening;
	var $nama_bank;
	var $acc_no;
	...
	function __construct() {
		...
		$this->TableVar = 'tbl_bank';
		$this->TableName = 'tbl_bank';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`tbl_bank`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// bank_id
		$this->bank_id = new cField('tbl_bank', 'tbl_bank', 'x_bank_id', 'bank_id', '`bank_id`', '`bank_id`', 3, -1, FALSE, '`bank_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->bank_id->Sortable = FALSE; // Allow sort
		$this->bank_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['bank_id'] = &$this->bank_id;

		// no_rekening
		$this->no_rekening = new cField('tbl_bank', 'tbl_bank', 'x_no_rekening', 'no_rekening', '`no_rekening`', '`no_rekening`', 200, -1, FALSE, '`no_rekening`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->no_rekening->Sortable = TRUE; // Allow sort
		$this->fields['no_rekening'] = &$this->no_rekening;

		// nama_bank
		$this->nama_bank = new cField('tbl_bank', 'tbl_bank', 'x_nama_bank', 'nama_bank', '`nama_bank`', '`nama_bank`', 200, -1, FALSE, '`nama_bank`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama_bank->Sortable = TRUE; // Allow sort
		$this->fields['nama_bank'] = &$this->nama_bank;

		// acc_no
		$this->acc_no = new cField('tbl_bank', 'tbl_bank', 'x_acc_no', 'acc_no', '`acc_no`', '`acc_no`', 200, -1, FALSE, '`acc_no`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->acc_no->Sortable = TRUE; // Allow sort
		$this->fields['acc_no'] = &$this->acc_no;

		// kode_depo
		$this->kode_depo = new cField('tbl_bank', 'tbl_bank', 'x_kode_depo', 'kode_depo', '`kode_depo`', '`kode_depo`', 200, -1, FALSE, '`kode_depo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`tbl_bank`";
	}
	...
	function getSqlOrderBy() { // Order By
		return ($this->_SqlOrderBy <> "") ? $this->_SqlOrderBy : "`nama_bank` ASC,`no_rekening` ASC";
	}
	...
	function Insert(&$rs) {
		...
		if ($bInsert) {
			...
			$rs['bank_id'] = $this->bank_id->DbValue;
		}
		return $bInsert;
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "tbl_bankedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "tbl_bankadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("tbl_bankview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("tbl_bankview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "tbl_bankadd.php?" . $this->UrlParm($parm);
		else
			$url = "tbl_bankadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("tbl_bankedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("tbl_bankadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("tbl_bankdelete.php", $this->UrlParm());
	}
	...
	function GetRecordKeys() {
		...
		if (isset($_POST["key_m"])) {
			...
			$isPost = ew_IsPost();
			if ($isPost && isset($_POST["bank_id"]))
				$arKeys[] = $_POST["bank_id"];
