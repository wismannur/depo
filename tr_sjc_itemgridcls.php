...
$tr_sjc_item_grid = NULL; // Initialize page object first

class ctr_sjc_item_grid extends ctr_sjc_item {
	...
	// Page object name
	var $PageObjName = 'tr_sjc_item_grid';

	// Grid form hidden field names
	var $FormName = 'ftr_sjc_itemgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["tr_sjc_item"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function SetupMasterParms() {
		...
		if ($sMasterTblVar == "tr_sjc_master") {
			...
			if ($GLOBALS["tr_sjc_master"]->EventCancelled) $this->EventCancelled = TRUE;
		}
