...
$tr_inv_canvas_item_grid = NULL; // Initialize page object first

class ctr_inv_canvas_item_grid extends ctr_inv_canvas_item {
	...
	// Page object name
	var $PageObjName = 'tr_inv_canvas_item_grid';

	// Grid form hidden field names
	var $FormName = 'ftr_inv_canvas_itemgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["tr_inv_canvas_item"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function SetupMasterParms() {
		...
		if ($sMasterTblVar == "tr_inv_canvas_master") {
			...
			if ($GLOBALS["tr_inv_canvas_master"]->EventCancelled) $this->EventCancelled = TRUE;
		}
