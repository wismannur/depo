...
$tr_retc_item_add = NULL; // Initialize page object first

class ctr_retc_item_add extends ctr_retc_item {
	...
	// Page object name
	var $PageObjName = 'tr_retc_item_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "tr_retc_itemview.php")
...
// Create page object
if (!isset($tr_retc_item_add)) $tr_retc_item_add = new ctr_retc_item_add();

// Page init
$tr_retc_item_add->Page_Init();

// Page main
$tr_retc_item_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tr_retc_item_add->Page_Render();
?>
...
var CurrentForm = ftr_retc_itemadd = new ew_Form("ftr_retc_itemadd", "add");

// Validate form
ftr_retc_itemadd.Validate = function() {
...
ftr_retc_itemadd.Form_CustomValidate = 
...
ftr_retc_itemadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
ftr_retc_itemadd.Lists["x_item_id"] = {"LinkField":"x_product_id","Ajax":true,"AutoFill":true,"DisplayFields":["x_product_name","","",""],"ParentFields":[],"ChildFields":["x_udet_id"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"view_products_unit_price"};
ftr_retc_itemadd.Lists["x_item_id"].Data = "<?php echo $tr_retc_item_add->item_id->LookupFilterQuery(FALSE, "add") ?>";
ftr_retc_itemadd.AutoSuggests["x_item_id"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $tr_retc_item_add->item_id->LookupFilterQuery(TRUE, "add"))) ?>;
ftr_retc_itemadd.Lists["x_udet_id"] = {"LinkField":"x_udet_id","Ajax":true,"AutoFill":true,"DisplayFields":["x_unit_name","","",""],"ParentFields":["x_item_id"],"ChildFields":[],"FilterFields":["x_product_id"],"Options":[],"Template":"","LinkTable":"tbl_unit_detail"};
ftr_retc_itemadd.Lists["x_udet_id"].Data = "<?php echo $tr_retc_item_add->udet_id->LookupFilterQuery(FALSE, "add") ?>";
ftr_retc_itemadd.Lists["x_is_bs[]"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ftr_retc_itemadd.Lists["x_is_bs[]"].Options = <?php echo json_encode($tr_retc_item_add->is_bs->Options()) ?>;
...
<?php $tr_retc_item_add->ShowPageHeader(); ?>
<?php
$tr_retc_item_add->ShowMessage();
?>
<form name="ftr_retc_itemadd" id="ftr_retc_itemadd" class="<?php echo $tr_retc_item_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($tr_retc_item_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tr_retc_item_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="tr_retc_item">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($tr_retc_item_add->IsModal) ?>">
...
<?php } ?>
<?php if (!$tr_retc_item_add->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($tr_retc_item_add->IsMobileOrModal) { ?>
<div class="ewAddDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_tr_retc_itemadd" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
<?php if ($tr_retc_item->item_id->Visible) { // item_id ?>
<?php if ($tr_retc_item_add->IsMobileOrModal) { ?>
	<div id="r_item_id" class="form-group">
		<label id="elh_tr_retc_item_item_id" class="<?php echo $tr_retc_item_add->LeftColumnClass ?>"><?php echo $tr_retc_item->item_id->FldCaption() ?></label>
		<div class="<?php echo $tr_retc_item_add->RightColumnClass ?>"><div<?php echo $tr_retc_item->item_id->CellAttributes() ?>>
...
<script type="text/javascript">
ftr_retc_itemadd.CreateAutoSuggest({"id":"x_item_id","forceSelect":true});
</script>
...
<?php if ($tr_retc_item_add->IsMobileOrModal) { ?>
	<div id="r_item_code" class="form-group">
		<label id="elh_tr_retc_item_item_code" for="x_item_code" class="<?php echo $tr_retc_item_add->LeftColumnClass ?>"><?php echo $tr_retc_item->item_code->FldCaption() ?></label>
		<div class="<?php echo $tr_retc_item_add->RightColumnClass ?>"><div<?php echo $tr_retc_item->item_code->CellAttributes() ?>>
...
<?php if ($tr_retc_item_add->IsMobileOrModal) { ?>
	<div id="r_item_name" class="form-group">
		<label id="elh_tr_retc_item_item_name" class="<?php echo $tr_retc_item_add->LeftColumnClass ?>"><?php echo $tr_retc_item->item_name->FldCaption() ?></label>
		<div class="<?php echo $tr_retc_item_add->RightColumnClass ?>"><div<?php echo $tr_retc_item->item_name->CellAttributes() ?>>
<span id="el_tr_retc_item_item_name">
<input type="text" data-table="tr_retc_item" data-field="x_item_name" name="x_item_name" id="x_item_name" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($tr_retc_item->item_name->getPlaceHolder()) ?>" value="<?php echo $tr_retc_item->item_name->EditValue ?>"<?php echo $tr_retc_item->item_name->EditAttributes() ?>>
</span>
<?php echo $tr_retc_item->item_name->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_item_name">
		<td class="col-sm-2"><span id="elh_tr_retc_item_item_name"><?php echo $tr_retc_item->item_name->FldCaption() ?></span></td>
		<td<?php echo $tr_retc_item->item_name->CellAttributes() ?>>
<span id="el_tr_retc_item_item_name">
<input type="text" data-table="tr_retc_item" data-field="x_item_name" name="x_item_name" id="x_item_name" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($tr_retc_item->item_name->getPlaceHolder()) ?>" value="<?php echo $tr_retc_item->item_name->EditValue ?>"<?php echo $tr_retc_item->item_name->EditAttributes() ?>>
</span>
<?php echo $tr_retc_item->item_name->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
...
<?php if ($tr_retc_item_add->IsMobileOrModal) { ?>
	<div id="r_udet_id" class="form-group">
		<label id="elh_tr_retc_item_udet_id" for="x_udet_id" class="<?php echo $tr_retc_item_add->LeftColumnClass ?>"><?php echo $tr_retc_item->udet_id->FldCaption() ?></label>
		<div class="<?php echo $tr_retc_item_add->RightColumnClass ?>"><div<?php echo $tr_retc_item->udet_id->CellAttributes() ?>>
...
<?php if ($tr_retc_item_add->IsMobileOrModal) { ?>
	<div id="r_item_qty" class="form-group">
		<label id="elh_tr_retc_item_item_qty" for="x_item_qty" class="<?php echo $tr_retc_item_add->LeftColumnClass ?>"><?php echo $tr_retc_item->item_qty->FldCaption() ?></label>
		<div class="<?php echo $tr_retc_item_add->RightColumnClass ?>"><div<?php echo $tr_retc_item->item_qty->CellAttributes() ?>>
...
<?php if ($tr_retc_item_add->IsMobileOrModal) { ?>
	<div id="r_is_bs" class="form-group">
		<label id="elh_tr_retc_item_is_bs" class="<?php echo $tr_retc_item_add->LeftColumnClass ?>"><?php echo $tr_retc_item->is_bs->FldCaption() ?></label>
		<div class="<?php echo $tr_retc_item_add->RightColumnClass ?>"><div<?php echo $tr_retc_item->is_bs->CellAttributes() ?>>
...
<?php if ($tr_retc_item_add->IsMobileOrModal) { ?>
	<div id="r_unit_id" class="form-group">
		<label id="elh_tr_retc_item_unit_id" for="x_unit_id" class="<?php echo $tr_retc_item_add->LeftColumnClass ?>"><?php echo $tr_retc_item->unit_id->FldCaption() ?></label>
		<div class="<?php echo $tr_retc_item_add->RightColumnClass ?>"><div<?php echo $tr_retc_item->unit_id->CellAttributes() ?>>
...
<?php } ?>
<?php if (strval($tr_retc_item->master_id->getSessionValue()) <> "") { ?>
<input type="hidden" name="x_master_id" id="x_master_id" value="<?php echo ew_HtmlEncode(strval($tr_retc_item->master_id->getSessionValue())) ?>">
<?php } ?>
<?php if (!$tr_retc_item_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $tr_retc_item_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $tr_retc_item_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
ftr_retc_itemadd.Init();
</script>
<?php
$tr_retc_item_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$tr_retc_item_add->Page_Terminate();
?>
