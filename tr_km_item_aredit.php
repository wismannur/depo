...
$tr_km_item_ar_edit = NULL; // Initialize page object first

class ctr_km_item_ar_edit extends ctr_km_item_ar {
	...
	// Page object name
	var $PageObjName = 'tr_km_item_ar_edit';
...
// Create page object
if (!isset($tr_km_item_ar_edit)) $tr_km_item_ar_edit = new ctr_km_item_ar_edit();

// Page init
$tr_km_item_ar_edit->Page_Init();

// Page main
$tr_km_item_ar_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tr_km_item_ar_edit->Page_Render();
?>
...
var CurrentForm = ftr_km_item_aredit = new ew_Form("ftr_km_item_aredit", "edit");

// Validate form
ftr_km_item_aredit.Validate = function() {
...
ftr_km_item_aredit.Form_CustomValidate = 
...
ftr_km_item_aredit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
ftr_km_item_aredit.Lists["x_customer_id"] = {"LinkField":"x_customer_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_customer_name","","",""],"ParentFields":[],"ChildFields":["x_inv_number"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tbl_customer"};
ftr_km_item_aredit.Lists["x_customer_id"].Data = "<?php echo $tr_km_item_ar_edit->customer_id->LookupFilterQuery(FALSE, "edit") ?>";
ftr_km_item_aredit.Lists["x_inv_number"] = {"LinkField":"x_inv_number","Ajax":true,"AutoFill":true,"DisplayFields":["x_inv_number","","",""],"ParentFields":["x_customer_id"],"ChildFields":[],"FilterFields":["x_customer_id"],"Options":[],"Template":"","LinkTable":"tr_inv_master"};
ftr_km_item_aredit.Lists["x_inv_number"].Data = "<?php echo $tr_km_item_ar_edit->inv_number->LookupFilterQuery(FALSE, "edit") ?>";
...
<?php $tr_km_item_ar_edit->ShowPageHeader(); ?>
<?php
$tr_km_item_ar_edit->ShowMessage();
?>
<form name="ftr_km_item_aredit" id="ftr_km_item_aredit" class="<?php echo $tr_km_item_ar_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($tr_km_item_ar_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tr_km_item_ar_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="tr_km_item_ar">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($tr_km_item_ar_edit->IsModal) ?>">
...
<?php } ?>
<?php if (!$tr_km_item_ar_edit->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($tr_km_item_ar_edit->IsMobileOrModal) { ?>
<div class="ewEditDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_tr_km_item_aredit" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
<?php if ($tr_km_item_ar->customer_id->Visible) { // customer_id ?>
<?php if ($tr_km_item_ar_edit->IsMobileOrModal) { ?>
	<div id="r_customer_id" class="form-group">
		<label id="elh_tr_km_item_ar_customer_id" for="x_customer_id" class="<?php echo $tr_km_item_ar_edit->LeftColumnClass ?>"><?php echo $tr_km_item_ar->customer_id->FldCaption() ?></label>
		<div class="<?php echo $tr_km_item_ar_edit->RightColumnClass ?>"><div<?php echo $tr_km_item_ar->customer_id->CellAttributes() ?>>
...
<?php if ($tr_km_item_ar_edit->IsMobileOrModal) { ?>
	<div id="r_inv_number" class="form-group">
		<label id="elh_tr_km_item_ar_inv_number" for="x_inv_number" class="<?php echo $tr_km_item_ar_edit->LeftColumnClass ?>"><?php echo $tr_km_item_ar->inv_number->FldCaption() ?></label>
		<div class="<?php echo $tr_km_item_ar_edit->RightColumnClass ?>"><div<?php echo $tr_km_item_ar->inv_number->CellAttributes() ?>>
...
<?php if ($tr_km_item_ar_edit->IsMobileOrModal) { ?>
	<div id="r_inv_date" class="form-group">
		<label id="elh_tr_km_item_ar_inv_date" for="x_inv_date" class="<?php echo $tr_km_item_ar_edit->LeftColumnClass ?>"><?php echo $tr_km_item_ar->inv_date->FldCaption() ?></label>
		<div class="<?php echo $tr_km_item_ar_edit->RightColumnClass ?>"><div<?php echo $tr_km_item_ar->inv_date->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("ftr_km_item_aredit", "x_inv_date", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($tr_km_item_ar_edit->IsMobileOrModal) { ?>
	<div id="r_inv_amt" class="form-group">
		<label id="elh_tr_km_item_ar_inv_amt" for="x_inv_amt" class="<?php echo $tr_km_item_ar_edit->LeftColumnClass ?>"><?php echo $tr_km_item_ar->inv_amt->FldCaption() ?></label>
		<div class="<?php echo $tr_km_item_ar_edit->RightColumnClass ?>"><div<?php echo $tr_km_item_ar->inv_amt->CellAttributes() ?>>
...
<?php if ($tr_km_item_ar_edit->IsMobileOrModal) { ?>
	<div id="r_paid_amt" class="form-group">
		<label id="elh_tr_km_item_ar_paid_amt" for="x_paid_amt" class="<?php echo $tr_km_item_ar_edit->LeftColumnClass ?>"><?php echo $tr_km_item_ar->paid_amt->FldCaption() ?></label>
		<div class="<?php echo $tr_km_item_ar_edit->RightColumnClass ?>"><div<?php echo $tr_km_item_ar->paid_amt->CellAttributes() ?>>
...
<?php } ?>
<input type="hidden" data-table="tr_km_item_ar" data-field="x_row_id" name="x_row_id" id="x_row_id" value="<?php echo ew_HtmlEncode($tr_km_item_ar->row_id->CurrentValue) ?>">
<?php if (!$tr_km_item_ar_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $tr_km_item_ar_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $tr_km_item_ar_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
ftr_km_item_aredit.Init();
</script>
<?php
$tr_km_item_ar_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$tr_km_item_ar_edit->Page_Terminate();
?>
