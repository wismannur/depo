...
define("EW_PROJECT_NAME", "depo", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{810F9B4D-139E-435A-ABF7-3C676CFEC5C5}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'n4R1NFNDcwp4jRpY', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/depo.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "12345", "db" => "db_inventory_depo", "qs" => "`", "qe" => "`");
$EW_CONN[0] = &$EW_CONN["DB"];
$EW_CONN["db_inventory_pusat"] = array("conn" => NULL, "id" => "db_inventory_pusat", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "12345", "db" => "db_inventory_pusat", "qs" => "`", "qe" => "`", "new" => TRUE);
$EW_CONN[1] = &$EW_CONN["db_inventory_pusat"];
