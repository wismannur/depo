...
$tr_km_item_ar_add = NULL; // Initialize page object first

class ctr_km_item_ar_add extends ctr_km_item_ar {
	...
	// Page object name
	var $PageObjName = 'tr_km_item_ar_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->Page_Terminate("tr_km_item_arlist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					$sReturnUrl = "tr_km_item_arlist.php";
					if (ew_GetPageName($sReturnUrl) == "tr_km_item_arlist.php")
						$sReturnUrl = $this->AddMasterUrl($sReturnUrl); // List page, return to List page with correct master key if necessary
					elseif (ew_GetPageName($sReturnUrl) == "tr_km_item_arview.php")
...
// Create page object
if (!isset($tr_km_item_ar_add)) $tr_km_item_ar_add = new ctr_km_item_ar_add();

// Page init
$tr_km_item_ar_add->Page_Init();

// Page main
$tr_km_item_ar_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tr_km_item_ar_add->Page_Render();
?>
...
var CurrentForm = ftr_km_item_aradd = new ew_Form("ftr_km_item_aradd", "add");

// Validate form
ftr_km_item_aradd.Validate = function() {
...
ftr_km_item_aradd.Form_CustomValidate = 
...
ftr_km_item_aradd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
ftr_km_item_aradd.Lists["x_customer_id"] = {"LinkField":"x_customer_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_customer_name","","",""],"ParentFields":[],"ChildFields":["x_inv_number"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tbl_customer"};
ftr_km_item_aradd.Lists["x_customer_id"].Data = "<?php echo $tr_km_item_ar_add->customer_id->LookupFilterQuery(FALSE, "add") ?>";
ftr_km_item_aradd.Lists["x_inv_number"] = {"LinkField":"x_inv_number","Ajax":true,"AutoFill":true,"DisplayFields":["x_inv_number","","",""],"ParentFields":["x_customer_id"],"ChildFields":[],"FilterFields":["x_customer_id"],"Options":[],"Template":"","LinkTable":"tr_inv_master"};
ftr_km_item_aradd.Lists["x_inv_number"].Data = "<?php echo $tr_km_item_ar_add->inv_number->LookupFilterQuery(FALSE, "add") ?>";
...
<?php $tr_km_item_ar_add->ShowPageHeader(); ?>
<?php
$tr_km_item_ar_add->ShowMessage();
?>
<form name="ftr_km_item_aradd" id="ftr_km_item_aradd" class="<?php echo $tr_km_item_ar_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($tr_km_item_ar_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tr_km_item_ar_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="tr_km_item_ar">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($tr_km_item_ar_add->IsModal) ?>">
<?php if ($tr_km_item_ar->getCurrentMasterTable() == "tr_km_master_ar") { ?>
...
<?php } ?>
<?php if (!$tr_km_item_ar_add->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($tr_km_item_ar_add->IsMobileOrModal) { ?>
<div class="ewAddDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_tr_km_item_aradd" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
<?php if ($tr_km_item_ar->customer_id->Visible) { // customer_id ?>
<?php if ($tr_km_item_ar_add->IsMobileOrModal) { ?>
	<div id="r_customer_id" class="form-group">
		<label id="elh_tr_km_item_ar_customer_id" for="x_customer_id" class="<?php echo $tr_km_item_ar_add->LeftColumnClass ?>"><?php echo $tr_km_item_ar->customer_id->FldCaption() ?></label>
		<div class="<?php echo $tr_km_item_ar_add->RightColumnClass ?>"><div<?php echo $tr_km_item_ar->customer_id->CellAttributes() ?>>
<span id="el_tr_km_item_ar_customer_id">
...
<?php echo $tr_km_item_ar->customer_id->RadioButtonListHtml(TRUE, "x_customer_id") ?>
		</div>
	</div>
	<div id="tp_x_customer_id" class="ewTemplate"><input type="radio" data-table="tr_km_item_ar" data-field="x_customer_id" data-value-separator="<?php echo $tr_km_item_ar->customer_id->DisplayValueSeparatorAttribute() ?>" name="x_customer_id" id="x_customer_id" value="{value}"<?php echo $tr_km_item_ar->customer_id->EditAttributes() ?>></div>
</div>
</span>
<?php echo $tr_km_item_ar->customer_id->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_customer_id">
		<td class="col-sm-2"><span id="elh_tr_km_item_ar_customer_id"><?php echo $tr_km_item_ar->customer_id->FldCaption() ?></span></td>
...
<?php echo $tr_km_item_ar->customer_id->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
...
<?php if ($tr_km_item_ar_add->IsMobileOrModal) { ?>
	<div id="r_inv_number" class="form-group">
		<label id="elh_tr_km_item_ar_inv_number" for="x_inv_number" class="<?php echo $tr_km_item_ar_add->LeftColumnClass ?>"><?php echo $tr_km_item_ar->inv_number->FldCaption() ?></label>
		<div class="<?php echo $tr_km_item_ar_add->RightColumnClass ?>"><div<?php echo $tr_km_item_ar->inv_number->CellAttributes() ?>>
...
<div class="ewDropdownList has-feedback">
	...
	<div id="dsl_x_inv_number" data-repeatcolumn="1" class="dropdown-menu">
		<div class="ewItems" style="position: relative; overflow-x: hidden;">
<?php echo $tr_km_item_ar->inv_number->RadioButtonListHtml(TRUE, "x_inv_number") ?>
		</div>
	</div>
	<div id="tp_x_inv_number" class="ewTemplate"><input type="radio" data-table="tr_km_item_ar" data-field="x_inv_number" data-value-separator="<?php echo $tr_km_item_ar->inv_number->DisplayValueSeparatorAttribute() ?>" name="x_inv_number" id="x_inv_number" value="{value}"<?php echo $tr_km_item_ar->inv_number->EditAttributes() ?>></div>
</div>
<input type="hidden" name="ln_x_inv_number" id="ln_x_inv_number" value="x_inv_date,x_inv_amt,x_paid_amt">
</span>
<?php echo $tr_km_item_ar->inv_number->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_inv_number">
...
<?php echo $tr_km_item_ar->inv_number->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
...
<?php if ($tr_km_item_ar_add->IsMobileOrModal) { ?>
	<div id="r_inv_date" class="form-group">
		<label id="elh_tr_km_item_ar_inv_date" for="x_inv_date" class="<?php echo $tr_km_item_ar_add->LeftColumnClass ?>"><?php echo $tr_km_item_ar->inv_date->FldCaption() ?></label>
		<div class="<?php echo $tr_km_item_ar_add->RightColumnClass ?>"><div<?php echo $tr_km_item_ar->inv_date->CellAttributes() ?>>
<span id="el_tr_km_item_ar_inv_date">
<input type="text" data-table="tr_km_item_ar" data-field="x_inv_date" name="x_inv_date" id="x_inv_date" size="10" placeholder="<?php echo ew_HtmlEncode($tr_km_item_ar->inv_date->getPlaceHolder()) ?>" value="<?php echo $tr_km_item_ar->inv_date->EditValue ?>"<?php echo $tr_km_item_ar->inv_date->EditAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("ftr_km_item_aradd", "x_inv_date", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
<?php echo $tr_km_item_ar->inv_date->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_inv_date">
...
<?php echo $tr_km_item_ar->inv_date->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
...
<?php if ($tr_km_item_ar_add->IsMobileOrModal) { ?>
	<div id="r_inv_amt" class="form-group">
		<label id="elh_tr_km_item_ar_inv_amt" for="x_inv_amt" class="<?php echo $tr_km_item_ar_add->LeftColumnClass ?>"><?php echo $tr_km_item_ar->inv_amt->FldCaption() ?></label>
		<div class="<?php echo $tr_km_item_ar_add->RightColumnClass ?>"><div<?php echo $tr_km_item_ar->inv_amt->CellAttributes() ?>>
<span id="el_tr_km_item_ar_inv_amt">
<input type="text" data-table="tr_km_item_ar" data-field="x_inv_amt" name="x_inv_amt" id="x_inv_amt" size="30" placeholder="<?php echo ew_HtmlEncode($tr_km_item_ar->inv_amt->getPlaceHolder()) ?>" value="<?php echo $tr_km_item_ar->inv_amt->EditValue ?>"<?php echo $tr_km_item_ar->inv_amt->EditAttributes() ?>>
</span>
<?php echo $tr_km_item_ar->inv_amt->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_inv_amt">
...
<?php echo $tr_km_item_ar->inv_amt->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
...
<?php if ($tr_km_item_ar_add->IsMobileOrModal) { ?>
	<div id="r_paid_amt" class="form-group">
		<label id="elh_tr_km_item_ar_paid_amt" for="x_paid_amt" class="<?php echo $tr_km_item_ar_add->LeftColumnClass ?>"><?php echo $tr_km_item_ar->paid_amt->FldCaption() ?></label>
		<div class="<?php echo $tr_km_item_ar_add->RightColumnClass ?>"><div<?php echo $tr_km_item_ar->paid_amt->CellAttributes() ?>>
<span id="el_tr_km_item_ar_paid_amt">
<input type="text" data-table="tr_km_item_ar" data-field="x_paid_amt" name="x_paid_amt" id="x_paid_amt" size="30" placeholder="<?php echo ew_HtmlEncode($tr_km_item_ar->paid_amt->getPlaceHolder()) ?>" value="<?php echo $tr_km_item_ar->paid_amt->EditValue ?>"<?php echo $tr_km_item_ar->paid_amt->EditAttributes() ?>>
</span>
<?php echo $tr_km_item_ar->paid_amt->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_paid_amt">
...
<?php echo $tr_km_item_ar->paid_amt->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
<?php if ($tr_km_item_ar_add->IsMobileOrModal) { ?>
...
<?php } ?>
<?php if (strval($tr_km_item_ar->master_id->getSessionValue()) <> "") { ?>
<input type="hidden" name="x_master_id" id="x_master_id" value="<?php echo ew_HtmlEncode(strval($tr_km_item_ar->master_id->getSessionValue())) ?>">
<?php } ?>
<?php if (!$tr_km_item_ar_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $tr_km_item_ar_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $tr_km_item_ar_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
ftr_km_item_aradd.Init();
</script>
<?php
$tr_km_item_ar_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$tr_km_item_ar_add->Page_Terminate();
?>
