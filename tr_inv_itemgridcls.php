...
$tr_inv_item_grid = NULL; // Initialize page object first

class ctr_inv_item_grid extends ctr_inv_item {
	...
	// Page object name
	var $PageObjName = 'tr_inv_item_grid';

	// Grid form hidden field names
	var $FormName = 'ftr_inv_itemgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["tr_inv_item"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function SetupMasterParms() {
		...
		if ($sMasterTblVar == "tr_inv_master") {
			...
			if ($GLOBALS["tr_inv_master"]->EventCancelled) $this->EventCancelled = TRUE;
		}
