...
$tr_sjd_item_grid = NULL; // Initialize page object first

class ctr_sjd_item_grid extends ctr_sjd_item {
	...
	// Page object name
	var $PageObjName = 'tr_sjd_item_grid';

	// Grid form hidden field names
	var $FormName = 'ftr_sjd_itemgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["tr_sjd_item"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function SetupMasterParms() {
		...
		if ($sMasterTblVar == "tr_sjd_master") {
			...
			if ($GLOBALS["tr_sjd_master"]->EventCancelled) $this->EventCancelled = TRUE;
		}
