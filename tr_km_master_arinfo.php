...
$tr_km_master_ar = NULL;

//
// Table class for tr_km_master_ar
//
class ctr_km_master_ar extends cTable {
	var $row_id;
	var $km_nomor;
	var $km_tanggal;
	var $customer_id;
	...
	function __construct() {
		...
		$this->TableVar = 'tr_km_master_ar';
		$this->TableName = 'tr_km_master_ar';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`tr_km_master_ar`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// row_id
		$this->row_id = new cField('tr_km_master_ar', 'tr_km_master_ar', 'x_row_id', 'row_id', '`row_id`', '`row_id`', 3, -1, FALSE, '`row_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// km_nomor
		$this->km_nomor = new cField('tr_km_master_ar', 'tr_km_master_ar', 'x_km_nomor', 'km_nomor', '`km_nomor`', '`km_nomor`', 200, -1, FALSE, '`km_nomor`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->km_nomor->Sortable = TRUE; // Allow sort
		$this->fields['km_nomor'] = &$this->km_nomor;

		// km_tanggal
		$this->km_tanggal = new cField('tr_km_master_ar', 'tr_km_master_ar', 'x_km_tanggal', 'km_tanggal', '`km_tanggal`', ew_CastDateFieldForLike('`km_tanggal`', 0, "DB"), 133, 0, FALSE, '`km_tanggal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// customer_id
		$this->customer_id = new cField('tr_km_master_ar', 'tr_km_master_ar', 'x_customer_id', 'customer_id', '`customer_id`', '`customer_id`', 3, -1, FALSE, '`customer_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// customer_name
		$this->customer_name = new cField('tr_km_master_ar', 'tr_km_master_ar', 'x_customer_name', 'customer_name', '`customer_name`', '`customer_name`', 200, -1, FALSE, '`customer_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->customer_name->Sortable = TRUE; // Allow sort
		$this->fields['customer_name'] = &$this->customer_name;

		// km_type
		$this->km_type = new cField('tr_km_master_ar', 'tr_km_master_ar', 'x_km_type', 'km_type', '`km_type`', '`km_type`', 202, -1, FALSE, '`km_type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		$this->km_type->Sortable = TRUE; // Allow sort
		$this->km_type->OptionCount = 2;
		$this->fields['km_type'] = &$this->km_type;

		// km_acc
		$this->km_acc = new cField('tr_km_master_ar', 'tr_km_master_ar', 'x_km_acc', 'km_acc', '`km_acc`', '`km_acc`', 200, -1, FALSE, '`km_acc`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->km_acc->Sortable = TRUE; // Allow sort
		$this->fields['km_acc'] = &$this->km_acc;

		// cek_no
		$this->cek_no = new cField('tr_km_master_ar', 'tr_km_master_ar', 'x_cek_no', 'cek_no', '`cek_no`', '`cek_no`', 200, -1, FALSE, '`cek_no`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->cek_no->Sortable = TRUE; // Allow sort
		$this->fields['cek_no'] = &$this->cek_no;

		// tgl_jt
		$this->tgl_jt = new cField('tr_km_master_ar', 'tr_km_master_ar', 'x_tgl_jt', 'tgl_jt', '`tgl_jt`', ew_CastDateFieldForLike('`tgl_jt`', 0, "DB"), 133, 0, FALSE, '`tgl_jt`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// cek_amt
		$this->cek_amt = new cField('tr_km_master_ar', 'tr_km_master_ar', 'x_cek_amt', 'cek_amt', '`cek_amt`', '`cek_amt`', 5, -1, FALSE, '`cek_amt`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ret_number1
		$this->ret_number1 = new cField('tr_km_master_ar', 'tr_km_master_ar', 'x_ret_number1', 'ret_number1', '`ret_number1`', '`ret_number1`', 200, -1, FALSE, '`ret_number1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->ret_number1->Sortable = TRUE; // Allow sort
		$this->ret_number1->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->ret_number1->PleaseSelectText = $Language->Phrase("PleaseSelect"); // PleaseSelect text
		$this->fields['ret_number1'] = &$this->ret_number1;

		// ret_date1
		$this->ret_date1 = new cField('tr_km_master_ar', 'tr_km_master_ar', 'x_ret_date1', 'ret_date1', '`ret_date1`', ew_CastDateFieldForLike('`ret_date1`', 0, "DB"), 133, 0, FALSE, '`ret_date1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// retur_amt1
		$this->retur_amt1 = new cField('tr_km_master_ar', 'tr_km_master_ar', 'x_retur_amt1', 'retur_amt1', '`retur_amt1`', '`retur_amt1`', 5, -1, FALSE, '`retur_amt1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ret_number2
		$this->ret_number2 = new cField('tr_km_master_ar', 'tr_km_master_ar', 'x_ret_number2', 'ret_number2', '`ret_number2`', '`ret_number2`', 200, -1, FALSE, '`ret_number2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->ret_number2->Sortable = TRUE; // Allow sort
		$this->ret_number2->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->ret_number2->PleaseSelectText = $Language->Phrase("PleaseSelect"); // PleaseSelect text
		$this->fields['ret_number2'] = &$this->ret_number2;

		// ret_date2
		$this->ret_date2 = new cField('tr_km_master_ar', 'tr_km_master_ar', 'x_ret_date2', 'ret_date2', '`ret_date2`', ew_CastDateFieldForLike('`ret_date2`', 0, "DB"), 133, 0, FALSE, '`ret_date2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// retur_amt2
		$this->retur_amt2 = new cField('tr_km_master_ar', 'tr_km_master_ar', 'x_retur_amt2', 'retur_amt2', '`retur_amt2`', '`retur_amt2`', 5, -1, FALSE, '`retur_amt2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ret_number3
		$this->ret_number3 = new cField('tr_km_master_ar', 'tr_km_master_ar', 'x_ret_number3', 'ret_number3', '`ret_number3`', '`ret_number3`', 200, -1, FALSE, '`ret_number3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->ret_number3->Sortable = TRUE; // Allow sort
		$this->ret_number3->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->ret_number3->PleaseSelectText = $Language->Phrase("PleaseSelect"); // PleaseSelect text
		$this->fields['ret_number3'] = &$this->ret_number3;

		// ret_date3
		$this->ret_date3 = new cField('tr_km_master_ar', 'tr_km_master_ar', 'x_ret_date3', 'ret_date3', '`ret_date3`', ew_CastDateFieldForLike('`ret_date3`', 0, "DB"), 133, 0, FALSE, '`ret_date3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// retur_amt3
		$this->retur_amt3 = new cField('tr_km_master_ar', 'tr_km_master_ar', 'x_retur_amt3', 'retur_amt3', '`retur_amt3`', '`retur_amt3`', 5, -1, FALSE, '`retur_amt3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tunai_amt
		$this->tunai_amt = new cField('tr_km_master_ar', 'tr_km_master_ar', 'x_tunai_amt', 'tunai_amt', '`tunai_amt`', '`tunai_amt`', 5, -1, FALSE, '`tunai_amt`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// dp_amt
		$this->dp_amt = new cField('tr_km_master_ar', 'tr_km_master_ar', 'x_dp_amt', 'dp_amt', '`dp_amt`', '`dp_amt`', 5, -1, FALSE, '`dp_amt`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// km_amt
		$this->km_amt = new cField('tr_km_master_ar', 'tr_km_master_ar', 'x_km_amt', 'km_amt', '`km_amt`', '`km_amt`', 5, -1, FALSE, '`km_amt`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// km_notes
		$this->km_notes = new cField('tr_km_master_ar', 'tr_km_master_ar', 'x_km_notes', 'km_notes', '`km_notes`', '`km_notes`', 200, -1, FALSE, '`km_notes`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->km_notes->Sortable = TRUE; // Allow sort
		$this->fields['km_notes'] = &$this->km_notes;

		// kas_amt
		$this->kas_amt = new cField('tr_km_master_ar', 'tr_km_master_ar', 'x_kas_amt', 'kas_amt', '\'\'', '\'\'', 201, -1, FALSE, '\'\'', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->kas_amt->FldIsCustom = TRUE; // Custom field
		$this->kas_amt->Sortable = TRUE; // Allow sort
		$this->fields['kas_amt'] = &$this->kas_amt;

		// kode_depo
		$this->kode_depo = new cField('tr_km_master_ar', 'tr_km_master_ar', 'x_kode_depo', 'kode_depo', '`kode_depo`', '`kode_depo`', 200, -1, FALSE, '`kode_depo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function GetDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "tr_km_item_ar") {
			$sDetailUrl = $GLOBALS["tr_km_item_ar"]->GetListUrl() . "?" . EW_TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$sDetailUrl .= "&fk_row_id=" . urlencode($this->row_id->CurrentValue);
		}
		if ($sDetailUrl == "") {
			$sDetailUrl = "tr_km_master_arlist.php";
		}
		return $sDetailUrl;
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`tr_km_master_ar`";
	}
	...
	function Delete(&$rs, $where = "", $curfilter = TRUE) {
		...
		// Cascade delete detail table 'tr_km_item_ar'
		if (!isset($GLOBALS["tr_km_item_ar"])) $GLOBALS["tr_km_item_ar"] = new ctr_km_item_ar();
		$rscascade = $GLOBALS["tr_km_item_ar"]->LoadRs("`master_id` = " . ew_QuotedValue($rs['row_id'], EW_DATATYPE_NUMBER, "DB")); 
		$dtlrows = ($rscascade) ? $rscascade->GetRows() : array();

		// Call Row Deleting event
		foreach ($dtlrows as $dtlrow) {
			$bDelete = $GLOBALS["tr_km_item_ar"]->Row_Deleting($dtlrow);
			if (!$bDelete) break;
		}
		if ($bDelete) {
			foreach ($dtlrows as $dtlrow) {
				$bDelete = $GLOBALS["tr_km_item_ar"]->Delete($dtlrow); // Delete
				if ($bDelete === FALSE)
					break;
			}
		}
		...
		if ($bDelete) {
			foreach ($dtlrows as $dtlrow) {
				$GLOBALS["tr_km_item_ar"]->Row_Deleted($dtlrow);
			}
		}
		if ($bDelete)
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "tr_km_master_arlist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "tr_km_master_aredit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "tr_km_master_aradd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("tr_km_master_arview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("tr_km_master_arview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "tr_km_master_aradd.php?" . $this->UrlParm($parm);
		else
			$url = "tr_km_master_aradd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("tr_km_master_aredit.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("tr_km_master_aredit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("tr_km_master_aradd.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("tr_km_master_aradd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("tr_km_master_ardelete.php", $this->UrlParm());
	}
	...
	function GetAutoFill($id, $val) {
		$rsarr = array();
		$rowcnt = 0;
		if (preg_match('/^x(\d)*_ret_number1$/', $id)) {
			$conn = &$this->Connection();
			$sSqlWrk = "SELECT `ret_date` AS FIELD0, `ret_total` AS FIELD1 FROM `tr_ret_master`";
			$sWhereWrk = "(`ret_number` = " . ew_QuotedValue($val, EW_DATATYPE_STRING, $this->DBID) . ")";
			$this->ret_number1->LookupFilters = array();
			$lookuptblfilter = (isset($_GET["customer_id"]))? "`customer_id` = '".@$_GET["customer_id"]."' AND `kode_depo` = '".@$_SESSION["KodeDepo"]."'" : "`kode_depo` = '".@$_SESSION["KodeDepo"]."'";
			ew_AddFilter($sWhereWrk, $lookuptblfilter);
			$this->Lookup_Selecting($this->ret_number1, $sWhereWrk); // Call Lookup Selecting
			...
			if ($rs = ew_LoadRecordset($sSqlWrk, $conn)) {
				while ($rs && !$rs->EOF) {
					$ar = array();
					$this->ret_date1->setDbValue($rs->fields[0]);
					$this->retur_amt1->setDbValue($rs->fields[1]);
					$this->RowType == EW_ROWTYPE_EDIT;
					$this->RenderEditRow();
					$ar[] = ($this->ret_date1->AutoFillOriginalValue) ? $this->ret_date1->CurrentValue : $this->ret_date1->EditValue;
					$ar[] = ($this->retur_amt1->AutoFillOriginalValue) ? $this->retur_amt1->CurrentValue : $this->retur_amt1->EditValue;
					$rowcnt += 1;
					$rsarr[] = $ar;
					$rs->MoveNext();
				}
		...
		if (preg_match('/^x(\d)*_ret_number2$/', $id)) {
			$conn = &$this->Connection();
			$sSqlWrk = "SELECT `ret_date` AS FIELD0, `ret_total` AS FIELD1 FROM `tr_ret_master`";
			$sWhereWrk = "(`ret_number` = " . ew_QuotedValue($val, EW_DATATYPE_STRING, $this->DBID) . ")";
			$this->ret_number2->LookupFilters = array();
			...
			if ($rs = ew_LoadRecordset($sSqlWrk, $conn)) {
				while ($rs && !$rs->EOF) {
					$ar = array();
					$this->ret_date2->setDbValue($rs->fields[0]);
					$this->retur_amt2->setDbValue($rs->fields[1]);
					$this->RowType == EW_ROWTYPE_EDIT;
					$this->RenderEditRow();
					$ar[] = ($this->ret_date2->AutoFillOriginalValue) ? $this->ret_date2->CurrentValue : $this->ret_date2->EditValue;
					$ar[] = ($this->retur_amt2->AutoFillOriginalValue) ? $this->retur_amt2->CurrentValue : $this->retur_amt2->EditValue;
					$rowcnt += 1;
					$rsarr[] = $ar;
					$rs->MoveNext();
				}
		...
		if (preg_match('/^x(\d)*_ret_number3$/', $id)) {
			$conn = &$this->Connection();
			$sSqlWrk = "SELECT `ret_date` AS FIELD0, `ret_total` AS FIELD1 FROM `tr_ret_master`";
			$sWhereWrk = "(`ret_number` = " . ew_QuotedValue($val, EW_DATATYPE_STRING, $this->DBID) . ")";
			$this->ret_number3->LookupFilters = array();
			...
			if ($rs = ew_LoadRecordset($sSqlWrk, $conn)) {
				while ($rs && !$rs->EOF) {
					$ar = array();
					$this->ret_date3->setDbValue($rs->fields[0]);
					$this->retur_amt3->setDbValue($rs->fields[1]);
					$this->RowType == EW_ROWTYPE_EDIT;
					$this->RenderEditRow();
					$ar[] = ($this->ret_date3->AutoFillOriginalValue) ? $this->ret_date3->CurrentValue : $this->ret_date3->EditValue;
					$ar[] = ($this->retur_amt3->AutoFillOriginalValue) ? $this->retur_amt3->CurrentValue : $this->retur_amt3->EditValue;
					$rowcnt += 1;
					$rsarr[] = $ar;
					$rs->MoveNext();
				}
	...
	function Row_Inserting($rsold, &$rsnew) {
		...
		$rsnew["km_nomor"] = GetNextkmNumber();
		return TRUE;
	}
	...
	function Row_Rendered() {
		...
		if (CurrentPageID() == "add") {
			$this->km_nomor->CurrentValue = GetNextkmNumber();
			$this->km_nomor->EditValue = $this->km_nomor->CurrentValue; 
		}
