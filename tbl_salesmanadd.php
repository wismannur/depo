...
$tbl_salesman_add = NULL; // Initialize page object first

class ctbl_salesman_add extends ctbl_salesman {
	...
	// Page object name
	var $PageObjName = 'tbl_salesman_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "tbl_salesmanview.php")
	...
	function LoadDefaultValues() {
		...
		$this->sales_name->CurrentValue = NULL;
		$this->sales_name->OldValue = $this->sales_name->CurrentValue;
		...
		$this->sales_target->CurrentValue = NULL;
		$this->sales_target->OldValue = $this->sales_target->CurrentValue;
		$this->sales_intensif->CurrentValue = NULL;
		$this->sales_intensif->OldValue = $this->sales_intensif->CurrentValue;
	...
	function NewRow() {
		...
		$row['sales_name'] = $this->sales_name->CurrentValue;
		...
		$row['sales_target'] = $this->sales_target->CurrentValue;
		$row['sales_intensif'] = $this->sales_intensif->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// sales_name
		$this->sales_name->SetDbValueDef($rsnew, $this->sales_name->CurrentValue, NULL, FALSE);
		...
		// sales_target
		$this->sales_target->SetDbValueDef($rsnew, $this->sales_target->CurrentValue, NULL, FALSE);

		// sales_intensif
		$this->sales_intensif->SetDbValueDef($rsnew, $this->sales_intensif->CurrentValue, NULL, FALSE);
...
// Create page object
if (!isset($tbl_salesman_add)) $tbl_salesman_add = new ctbl_salesman_add();

// Page init
$tbl_salesman_add->Page_Init();

// Page main
$tbl_salesman_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tbl_salesman_add->Page_Render();
?>
...
var CurrentForm = ftbl_salesmanadd = new ew_Form("ftbl_salesmanadd", "add");

// Validate form
ftbl_salesmanadd.Validate = function() {
...
ftbl_salesmanadd.Form_CustomValidate = 
...
ftbl_salesmanadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
ftbl_salesmanadd.Lists["x_wilayah_id"] = {"LinkField":"x_wilayah_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_wilayah","","",""],"ParentFields":[],"ChildFields":["x_subwil_id"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tbl_wilayah"};
ftbl_salesmanadd.Lists["x_wilayah_id"].Data = "<?php echo $tbl_salesman_add->wilayah_id->LookupFilterQuery(FALSE, "add") ?>";
ftbl_salesmanadd.Lists["x_subwil_id"] = {"LinkField":"x_sub_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_sub_wilayah","","",""],"ParentFields":["x_wilayah_id"],"ChildFields":["x_area_id"],"FilterFields":["x_wilayah_id"],"Options":[],"Template":"","LinkTable":"tbl_subwilayah"};
ftbl_salesmanadd.Lists["x_subwil_id"].Data = "<?php echo $tbl_salesman_add->subwil_id->LookupFilterQuery(FALSE, "add") ?>";
ftbl_salesmanadd.Lists["x_area_id"] = {"LinkField":"x_area_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_area_name","","",""],"ParentFields":["x_subwil_id"],"ChildFields":[],"FilterFields":["x_subwil_id"],"Options":[],"Template":"","LinkTable":"tbl_callarea"};
ftbl_salesmanadd.Lists["x_area_id"].Data = "<?php echo $tbl_salesman_add->area_id->LookupFilterQuery(FALSE, "add") ?>";
...
<?php $tbl_salesman_add->ShowPageHeader(); ?>
<?php
$tbl_salesman_add->ShowMessage();
?>
<form name="ftbl_salesmanadd" id="ftbl_salesmanadd" class="<?php echo $tbl_salesman_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($tbl_salesman_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tbl_salesman_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="tbl_salesman">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($tbl_salesman_add->IsModal) ?>">
<?php if (!$tbl_salesman_add->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($tbl_salesman_add->IsMobileOrModal) { ?>
<div class="ewAddDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_tbl_salesmanadd" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
<?php if ($tbl_salesman->sales_name->Visible) { // sales_name ?>
<?php if ($tbl_salesman_add->IsMobileOrModal) { ?>
	<div id="r_sales_name" class="form-group">
		<label id="elh_tbl_salesman_sales_name" for="x_sales_name" class="<?php echo $tbl_salesman_add->LeftColumnClass ?>"><?php echo $tbl_salesman->sales_name->FldCaption() ?></label>
		<div class="<?php echo $tbl_salesman_add->RightColumnClass ?>"><div<?php echo $tbl_salesman->sales_name->CellAttributes() ?>>
...
<?php if ($tbl_salesman_add->IsMobileOrModal) { ?>
	<div id="r_wilayah_id" class="form-group">
		<label id="elh_tbl_salesman_wilayah_id" for="x_wilayah_id" class="<?php echo $tbl_salesman_add->LeftColumnClass ?>"><?php echo $tbl_salesman->wilayah_id->FldCaption() ?></label>
		<div class="<?php echo $tbl_salesman_add->RightColumnClass ?>"><div<?php echo $tbl_salesman->wilayah_id->CellAttributes() ?>>
...
<?php if ($tbl_salesman_add->IsMobileOrModal) { ?>
	<div id="r_subwil_id" class="form-group">
		<label id="elh_tbl_salesman_subwil_id" for="x_subwil_id" class="<?php echo $tbl_salesman_add->LeftColumnClass ?>"><?php echo $tbl_salesman->subwil_id->FldCaption() ?></label>
		<div class="<?php echo $tbl_salesman_add->RightColumnClass ?>"><div<?php echo $tbl_salesman->subwil_id->CellAttributes() ?>>
...
<?php if ($tbl_salesman_add->IsMobileOrModal) { ?>
	<div id="r_area_id" class="form-group">
		<label id="elh_tbl_salesman_area_id" for="x_area_id" class="<?php echo $tbl_salesman_add->LeftColumnClass ?>"><?php echo $tbl_salesman->area_id->FldCaption() ?></label>
		<div class="<?php echo $tbl_salesman_add->RightColumnClass ?>"><div<?php echo $tbl_salesman->area_id->CellAttributes() ?>>
...
<?php if ($tbl_salesman_add->IsMobileOrModal) { ?>
	<div id="r_sales_target" class="form-group">
		<label id="elh_tbl_salesman_sales_target" for="x_sales_target" class="<?php echo $tbl_salesman_add->LeftColumnClass ?>"><?php echo $tbl_salesman->sales_target->FldCaption() ?></label>
		<div class="<?php echo $tbl_salesman_add->RightColumnClass ?>"><div<?php echo $tbl_salesman->sales_target->CellAttributes() ?>>
...
<?php if ($tbl_salesman_add->IsMobileOrModal) { ?>
	<div id="r_sales_intensif" class="form-group">
		<label id="elh_tbl_salesman_sales_intensif" for="x_sales_intensif" class="<?php echo $tbl_salesman_add->LeftColumnClass ?>"><?php echo $tbl_salesman->sales_intensif->FldCaption() ?></label>
		<div class="<?php echo $tbl_salesman_add->RightColumnClass ?>"><div<?php echo $tbl_salesman->sales_intensif->CellAttributes() ?>>
...
<?php } ?>
<?php if (!$tbl_salesman_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $tbl_salesman_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $tbl_salesman_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
ftbl_salesmanadd.Init();
</script>
<?php
$tbl_salesman_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$tbl_salesman_add->Page_Terminate();
?>
