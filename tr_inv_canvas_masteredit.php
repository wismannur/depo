...
$tr_inv_canvas_master_edit = NULL; // Initialize page object first

class ctr_inv_canvas_master_edit extends ctr_inv_canvas_master {
	...
	// Page object name
	var $PageObjName = 'tr_inv_canvas_master_edit';
	...
	function ValidateForm() {
		...
		if (in_array("tr_inv_canvas_item", $DetailTblVar) && $GLOBALS["tr_inv_canvas_item"]->DetailEdit) {
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			if ($tmpBool <> "1" && $tmpBool <> "0")
				$tmpBool = (!empty($tmpBool)) ? "1" : "0";
			$this->paid->SetDbValueDef($rsnew, $tmpBool, 0, $this->paid->ReadOnly);
			...
			if ($bUpdateRow) {
				...
				if ($EditRow) {
					if (in_array("tr_inv_canvas_item", $DetailTblVar) && $GLOBALS["tr_inv_canvas_item"]->DetailEdit) {
						...
						$EditRow = $GLOBALS["tr_inv_canvas_item_grid"]->GridUpdate();
	...
	function SetupDetailParms() {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("tr_inv_canvas_item", $DetailTblVar)) {
				...
				if ($GLOBALS["tr_inv_canvas_item_grid"]->DetailEdit) {
					$GLOBALS["tr_inv_canvas_item_grid"]->CurrentMode = "edit";
					$GLOBALS["tr_inv_canvas_item_grid"]->CurrentAction = "gridedit";
...
// Create page object
if (!isset($tr_inv_canvas_master_edit)) $tr_inv_canvas_master_edit = new ctr_inv_canvas_master_edit();

// Page init
$tr_inv_canvas_master_edit->Page_Init();

// Page main
$tr_inv_canvas_master_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tr_inv_canvas_master_edit->Page_Render();
?>
...
var CurrentForm = ftr_inv_canvas_masteredit = new ew_Form("ftr_inv_canvas_masteredit", "edit");

// Validate form
ftr_inv_canvas_masteredit.Validate = function() {
...
ftr_inv_canvas_masteredit.Form_CustomValidate = 
...
ftr_inv_canvas_masteredit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
ftr_inv_canvas_masteredit.Lists["x_customer_id"] = {"LinkField":"x_customer_id","Ajax":true,"AutoFill":true,"DisplayFields":["x_customer_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tbl_customer"};
ftr_inv_canvas_masteredit.Lists["x_customer_id"].Data = "<?php echo $tr_inv_canvas_master_edit->customer_id->LookupFilterQuery(FALSE, "edit") ?>";
ftr_inv_canvas_masteredit.AutoSuggests["x_customer_id"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $tr_inv_canvas_master_edit->customer_id->LookupFilterQuery(TRUE, "edit"))) ?>;
ftr_inv_canvas_masteredit.Lists["x_is_tax[]"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ftr_inv_canvas_masteredit.Lists["x_is_tax[]"].Options = <?php echo json_encode($tr_inv_canvas_master_edit->is_tax->Options()) ?>;
ftr_inv_canvas_masteredit.Lists["x_paid[]"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ftr_inv_canvas_masteredit.Lists["x_paid[]"].Options = <?php echo json_encode($tr_inv_canvas_master_edit->paid->Options()) ?>;
...
<?php $tr_inv_canvas_master_edit->ShowPageHeader(); ?>
<?php
$tr_inv_canvas_master_edit->ShowMessage();
?>
<form name="ftr_inv_canvas_masteredit" id="ftr_inv_canvas_masteredit" class="<?php echo $tr_inv_canvas_master_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($tr_inv_canvas_master_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tr_inv_canvas_master_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="tr_inv_canvas_master">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($tr_inv_canvas_master_edit->IsModal) ?>">
<div id="tpd_tr_inv_canvas_masteredit" class="ewCustomTemplate"></div>
<script id="tpm_tr_inv_canvas_masteredit" type="text/html">
<div id="ct_tr_inv_canvas_master_edit"><div class="col-sm-12 panel-custom" style="">
	<div class="row">
...
<?php if (!$tr_inv_canvas_master_edit->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($tr_inv_canvas_master_edit->IsMobileOrModal) { ?>
<div class="ewEditDiv hidden"><!-- page* -->
<?php } else { ?>
<table id="tbl_tr_inv_canvas_masteredit" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable hidden"><!-- table* -->
<?php } ?>
<?php if ($tr_inv_canvas_master->inv_number->Visible) { // inv_number ?>
<?php if ($tr_inv_canvas_master_edit->IsMobileOrModal) { ?>
	<div id="r_inv_number" class="form-group">
		<label id="elh_tr_inv_canvas_master_inv_number" for="x_inv_number" class="<?php echo $tr_inv_canvas_master_edit->LeftColumnClass ?>"><script id="tpc_tr_inv_canvas_master_inv_number" class="tr_inv_canvas_masteredit" type="text/html"><span><?php echo $tr_inv_canvas_master->inv_number->FldCaption() ?></span></script></label>
		<div class="<?php echo $tr_inv_canvas_master_edit->RightColumnClass ?>"><div<?php echo $tr_inv_canvas_master->inv_number->CellAttributes() ?>>
<script id="tpx_tr_inv_canvas_master_inv_number" class="tr_inv_canvas_masteredit" type="text/html">
...
<?php } else { ?>
	<tr id="r_inv_number">
		<td class="col-sm-2"><span id="elh_tr_inv_canvas_master_inv_number"><script id="tpc_tr_inv_canvas_master_inv_number" class="tr_inv_canvas_masteredit" type="text/html"><span><?php echo $tr_inv_canvas_master->inv_number->FldCaption() ?></span></script></span></td>
...
<?php if ($tr_inv_canvas_master_edit->IsMobileOrModal) { ?>
	<div id="r_inv_date" class="form-group">
		<label id="elh_tr_inv_canvas_master_inv_date" for="x_inv_date" class="<?php echo $tr_inv_canvas_master_edit->LeftColumnClass ?>"><script id="tpc_tr_inv_canvas_master_inv_date" class="tr_inv_canvas_masteredit" type="text/html"><span><?php echo $tr_inv_canvas_master->inv_date->FldCaption() ?></span></script></label>
		<div class="<?php echo $tr_inv_canvas_master_edit->RightColumnClass ?>"><div<?php echo $tr_inv_canvas_master->inv_date->CellAttributes() ?>>
<script id="tpx_tr_inv_canvas_master_inv_date" class="tr_inv_canvas_masteredit" type="text/html">
...
<script type="text/html" class="tr_inv_canvas_masteredit_js">
ew_CreateDateTimePicker("ftr_inv_canvas_masteredit", "x_inv_date", {"ignoreReadonly":true,"useCurrent":false,"format":7});
</script>
<?php echo $tr_inv_canvas_master->inv_date->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_inv_date">
		<td class="col-sm-2"><span id="elh_tr_inv_canvas_master_inv_date"><script id="tpc_tr_inv_canvas_master_inv_date" class="tr_inv_canvas_masteredit" type="text/html"><span><?php echo $tr_inv_canvas_master->inv_date->FldCaption() ?></span></script></span></td>
...
<?php if ($tr_inv_canvas_master_edit->IsMobileOrModal) { ?>
	<div id="r_due_date" class="form-group">
		<label id="elh_tr_inv_canvas_master_due_date" for="x_due_date" class="<?php echo $tr_inv_canvas_master_edit->LeftColumnClass ?>"><script id="tpc_tr_inv_canvas_master_due_date" class="tr_inv_canvas_masteredit" type="text/html"><span><?php echo $tr_inv_canvas_master->due_date->FldCaption() ?></span></script></label>
		<div class="<?php echo $tr_inv_canvas_master_edit->RightColumnClass ?>"><div<?php echo $tr_inv_canvas_master->due_date->CellAttributes() ?>>
<script id="tpx_tr_inv_canvas_master_due_date" class="tr_inv_canvas_masteredit" type="text/html">
...
<script type="text/html" class="tr_inv_canvas_masteredit_js">
ew_CreateDateTimePicker("ftr_inv_canvas_masteredit", "x_due_date", {"ignoreReadonly":true,"useCurrent":false,"format":7});
</script>
<?php echo $tr_inv_canvas_master->due_date->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_due_date">
		<td class="col-sm-2"><span id="elh_tr_inv_canvas_master_due_date"><script id="tpc_tr_inv_canvas_master_due_date" class="tr_inv_canvas_masteredit" type="text/html"><span><?php echo $tr_inv_canvas_master->due_date->FldCaption() ?></span></script></span></td>
...
<?php if ($tr_inv_canvas_master_edit->IsMobileOrModal) { ?>
	<div id="r_customer_id" class="form-group">
		<label id="elh_tr_inv_canvas_master_customer_id" class="<?php echo $tr_inv_canvas_master_edit->LeftColumnClass ?>"><script id="tpc_tr_inv_canvas_master_customer_id" class="tr_inv_canvas_masteredit" type="text/html"><span><?php echo $tr_inv_canvas_master->customer_id->FldCaption() ?></span></script></label>
		<div class="<?php echo $tr_inv_canvas_master_edit->RightColumnClass ?>"><div<?php echo $tr_inv_canvas_master->customer_id->CellAttributes() ?>>
<script id="tpx_tr_inv_canvas_master_customer_id" class="tr_inv_canvas_masteredit" type="text/html">
...
<script type="text/html" class="tr_inv_canvas_masteredit_js">
ftr_inv_canvas_masteredit.CreateAutoSuggest({"id":"x_customer_id","forceSelect":true});
</script>
<?php echo $tr_inv_canvas_master->customer_id->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_customer_id">
		<td class="col-sm-2"><span id="elh_tr_inv_canvas_master_customer_id"><script id="tpc_tr_inv_canvas_master_customer_id" class="tr_inv_canvas_masteredit" type="text/html"><span><?php echo $tr_inv_canvas_master->customer_id->FldCaption() ?></span></script></span></td>
...
<?php if ($tr_inv_canvas_master_edit->IsMobileOrModal) { ?>
	<div id="r_address1" class="form-group">
		<label id="elh_tr_inv_canvas_master_address1" for="x_address1" class="<?php echo $tr_inv_canvas_master_edit->LeftColumnClass ?>"><script id="tpc_tr_inv_canvas_master_address1" class="tr_inv_canvas_masteredit" type="text/html"><span><?php echo $tr_inv_canvas_master->address1->FldCaption() ?></span></script></label>
		<div class="<?php echo $tr_inv_canvas_master_edit->RightColumnClass ?>"><div<?php echo $tr_inv_canvas_master->address1->CellAttributes() ?>>
<script id="tpx_tr_inv_canvas_master_address1" class="tr_inv_canvas_masteredit" type="text/html">
...
<?php } else { ?>
	<tr id="r_address1">
		<td class="col-sm-2"><span id="elh_tr_inv_canvas_master_address1"><script id="tpc_tr_inv_canvas_master_address1" class="tr_inv_canvas_masteredit" type="text/html"><span><?php echo $tr_inv_canvas_master->address1->FldCaption() ?></span></script></span></td>
...
<?php if ($tr_inv_canvas_master_edit->IsMobileOrModal) { ?>
	<div id="r_address2" class="form-group">
		<label id="elh_tr_inv_canvas_master_address2" for="x_address2" class="<?php echo $tr_inv_canvas_master_edit->LeftColumnClass ?>"><script id="tpc_tr_inv_canvas_master_address2" class="tr_inv_canvas_masteredit" type="text/html"><span><?php echo $tr_inv_canvas_master->address2->FldCaption() ?></span></script></label>
		<div class="<?php echo $tr_inv_canvas_master_edit->RightColumnClass ?>"><div<?php echo $tr_inv_canvas_master->address2->CellAttributes() ?>>
<script id="tpx_tr_inv_canvas_master_address2" class="tr_inv_canvas_masteredit" type="text/html">
...
<?php } else { ?>
	<tr id="r_address2">
		<td class="col-sm-2"><span id="elh_tr_inv_canvas_master_address2"><script id="tpc_tr_inv_canvas_master_address2" class="tr_inv_canvas_masteredit" type="text/html"><span><?php echo $tr_inv_canvas_master->address2->FldCaption() ?></span></script></span></td>
...
<?php if ($tr_inv_canvas_master_edit->IsMobileOrModal) { ?>
	<div id="r_inv_amt" class="form-group">
		<label id="elh_tr_inv_canvas_master_inv_amt" for="x_inv_amt" class="<?php echo $tr_inv_canvas_master_edit->LeftColumnClass ?>"><script id="tpc_tr_inv_canvas_master_inv_amt" class="tr_inv_canvas_masteredit" type="text/html"><span><?php echo $tr_inv_canvas_master->inv_amt->FldCaption() ?></span></script></label>
		<div class="<?php echo $tr_inv_canvas_master_edit->RightColumnClass ?>"><div<?php echo $tr_inv_canvas_master->inv_amt->CellAttributes() ?>>
<script id="tpx_tr_inv_canvas_master_inv_amt" class="tr_inv_canvas_masteredit" type="text/html">
...
<?php } else { ?>
	<tr id="r_inv_amt">
		<td class="col-sm-2"><span id="elh_tr_inv_canvas_master_inv_amt"><script id="tpc_tr_inv_canvas_master_inv_amt" class="tr_inv_canvas_masteredit" type="text/html"><span><?php echo $tr_inv_canvas_master->inv_amt->FldCaption() ?></span></script></span></td>
...
<?php if ($tr_inv_canvas_master_edit->IsMobileOrModal) { ?>
	<div id="r_total_discount" class="form-group">
		<label id="elh_tr_inv_canvas_master_total_discount" for="x_total_discount" class="<?php echo $tr_inv_canvas_master_edit->LeftColumnClass ?>"><script id="tpc_tr_inv_canvas_master_total_discount" class="tr_inv_canvas_masteredit" type="text/html"><span><?php echo $tr_inv_canvas_master->total_discount->FldCaption() ?></span></script></label>
		<div class="<?php echo $tr_inv_canvas_master_edit->RightColumnClass ?>"><div<?php echo $tr_inv_canvas_master->total_discount->CellAttributes() ?>>
<script id="tpx_tr_inv_canvas_master_total_discount" class="tr_inv_canvas_masteredit" type="text/html">
...
<?php } else { ?>
	<tr id="r_total_discount">
		<td class="col-sm-2"><span id="elh_tr_inv_canvas_master_total_discount"><script id="tpc_tr_inv_canvas_master_total_discount" class="tr_inv_canvas_masteredit" type="text/html"><span><?php echo $tr_inv_canvas_master->total_discount->FldCaption() ?></span></script></span></td>
...
<?php if ($tr_inv_canvas_master_edit->IsMobileOrModal) { ?>
	<div id="r_is_tax" class="form-group">
		<label id="elh_tr_inv_canvas_master_is_tax" class="<?php echo $tr_inv_canvas_master_edit->LeftColumnClass ?>"><script id="tpc_tr_inv_canvas_master_is_tax" class="tr_inv_canvas_masteredit" type="text/html"><span><?php echo $tr_inv_canvas_master->is_tax->FldCaption() ?></span></script></label>
		<div class="<?php echo $tr_inv_canvas_master_edit->RightColumnClass ?>"><div<?php echo $tr_inv_canvas_master->is_tax->CellAttributes() ?>>
<script id="tpx_tr_inv_canvas_master_is_tax" class="tr_inv_canvas_masteredit" type="text/html">
...
<?php } else { ?>
	<tr id="r_is_tax">
		<td class="col-sm-2"><span id="elh_tr_inv_canvas_master_is_tax"><script id="tpc_tr_inv_canvas_master_is_tax" class="tr_inv_canvas_masteredit" type="text/html"><span><?php echo $tr_inv_canvas_master->is_tax->FldCaption() ?></span></script></span></td>
...
<?php if ($tr_inv_canvas_master_edit->IsMobileOrModal) { ?>
	<div id="r_inv_total" class="form-group">
		<label id="elh_tr_inv_canvas_master_inv_total" for="x_inv_total" class="<?php echo $tr_inv_canvas_master_edit->LeftColumnClass ?>"><script id="tpc_tr_inv_canvas_master_inv_total" class="tr_inv_canvas_masteredit" type="text/html"><span><?php echo $tr_inv_canvas_master->inv_total->FldCaption() ?></span></script></label>
		<div class="<?php echo $tr_inv_canvas_master_edit->RightColumnClass ?>"><div<?php echo $tr_inv_canvas_master->inv_total->CellAttributes() ?>>
<script id="tpx_tr_inv_canvas_master_inv_total" class="tr_inv_canvas_masteredit" type="text/html">
...
<?php } else { ?>
	<tr id="r_inv_total">
		<td class="col-sm-2"><span id="elh_tr_inv_canvas_master_inv_total"><script id="tpc_tr_inv_canvas_master_inv_total" class="tr_inv_canvas_masteredit" type="text/html"><span><?php echo $tr_inv_canvas_master->inv_total->FldCaption() ?></span></script></span></td>
...
<?php if ($tr_inv_canvas_master_edit->IsMobileOrModal) { ?>
	<div id="r_paid" class="form-group">
		<label id="elh_tr_inv_canvas_master_paid" class="<?php echo $tr_inv_canvas_master_edit->LeftColumnClass ?>"><script id="tpc_tr_inv_canvas_master_paid" class="tr_inv_canvas_masteredit" type="text/html"><span><?php echo $tr_inv_canvas_master->paid->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></script></label>
		<div class="<?php echo $tr_inv_canvas_master_edit->RightColumnClass ?>"><div<?php echo $tr_inv_canvas_master->paid->CellAttributes() ?>>
<script id="tpx_tr_inv_canvas_master_paid" class="tr_inv_canvas_masteredit" type="text/html">
...
<?php } else { ?>
	<tr id="r_paid">
		<td class="col-sm-2"><span id="elh_tr_inv_canvas_master_paid"><script id="tpc_tr_inv_canvas_master_paid" class="tr_inv_canvas_masteredit" type="text/html"><span><?php echo $tr_inv_canvas_master->paid->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></script></span></td>
...
<?php } ?>
<script id="tpx_tr_inv_canvas_master_tax_type" class="tr_inv_canvas_masteredit" type="text/html">
...
<script id="tpx_tr_inv_canvas_master_address3" class="tr_inv_canvas_masteredit" type="text/html">
<span id="el_tr_inv_canvas_master_address3">
<input type="hidden" data-table="tr_inv_canvas_master" data-field="x_address3" name="x_address3" id="x_address3" value="<?php echo ew_HtmlEncode($tr_inv_canvas_master->address3->CurrentValue) ?>">
</span>
</script>
<script id="tpx_tr_inv_canvas_master_wilayah_id" class="tr_inv_canvas_masteredit" type="text/html">
<span id="el_tr_inv_canvas_master_wilayah_id">
<input type="hidden" data-table="tr_inv_canvas_master" data-field="x_wilayah_id" name="x_wilayah_id" id="x_wilayah_id" value="<?php echo ew_HtmlEncode($tr_inv_canvas_master->wilayah_id->CurrentValue) ?>">
</span>
</script>
<script id="tpx_tr_inv_canvas_master_subwil_id" class="tr_inv_canvas_masteredit" type="text/html">
<span id="el_tr_inv_canvas_master_subwil_id">
<input type="hidden" data-table="tr_inv_canvas_master" data-field="x_subwil_id" name="x_subwil_id" id="x_subwil_id" value="<?php echo ew_HtmlEncode($tr_inv_canvas_master->subwil_id->CurrentValue) ?>">
</span>
</script>
<script id="tpx_tr_inv_canvas_master_area_id" class="tr_inv_canvas_masteredit" type="text/html">
<span id="el_tr_inv_canvas_master_area_id">
<input type="hidden" data-table="tr_inv_canvas_master" data-field="x_area_id" name="x_area_id" id="x_area_id" value="<?php echo ew_HtmlEncode($tr_inv_canvas_master->area_id->CurrentValue) ?>">
</span>
</script>
<script id="tpx_tr_inv_canvas_master_customer_name" class="tr_inv_canvas_masteredit" type="text/html">
<span id="el_tr_inv_canvas_master_customer_name">
<input type="hidden" data-table="tr_inv_canvas_master" data-field="x_customer_name" name="x_customer_name" id="x_customer_name" value="<?php echo ew_HtmlEncode($tr_inv_canvas_master->customer_name->CurrentValue) ?>">
</span>
</script>
<script id="tpx_tr_inv_canvas_master_tax_number" class="tr_inv_canvas_masteredit" type="text/html">
<span id="el_tr_inv_canvas_master_tax_number">
<input type="hidden" data-table="tr_inv_canvas_master" data-field="x_tax_number" name="x_tax_number" id="x_tax_number" value="<?php echo ew_HtmlEncode($tr_inv_canvas_master->tax_number->CurrentValue) ?>">
</span>
</script>
<script id="tpx_tr_inv_canvas_master_tc_number" class="tr_inv_canvas_masteredit" type="text/html">
<span id="el_tr_inv_canvas_master_tc_number">
<input type="hidden" data-table="tr_inv_canvas_master" data-field="x_tc_number" name="x_tc_number" id="x_tc_number" value="<?php echo ew_HtmlEncode($tr_inv_canvas_master->tc_number->CurrentValue) ?>">
</span>
</script>
<script id="tpx_tr_inv_canvas_master_tax_total" class="tr_inv_canvas_masteredit" type="text/html">
...
<script id="tpx_tr_inv_canvas_master_paid_amt" class="tr_inv_canvas_masteredit" type="text/html">
...
<script id="tpx_tr_inv_canvas_master_sales_id" class="tr_inv_canvas_masteredit" type="text/html">
<span id="el_tr_inv_canvas_master_sales_id">
<input type="hidden" data-table="tr_inv_canvas_master" data-field="x_sales_id" name="x_sales_id" id="x_sales_id" value="<?php echo ew_HtmlEncode($tr_inv_canvas_master->sales_id->CurrentValue) ?>">
</span>
</script>
<script id="tpx_tr_inv_canvas_master_kode_depo" class="tr_inv_canvas_masteredit" type="text/html">
<span id="el_tr_inv_canvas_master_kode_depo">
<input type="hidden" data-table="tr_inv_canvas_master" data-field="x_kode_depo" name="x_kode_depo" id="x_kode_depo" value="<?php echo ew_HtmlEncode($tr_inv_canvas_master->kode_depo->CurrentValue) ?>">
</span>
</script>
<input type="hidden" data-table="tr_inv_canvas_master" data-field="x_inv_id" name="x_inv_id" id="x_inv_id" value="<?php echo ew_HtmlEncode($tr_inv_canvas_master->inv_id->CurrentValue) ?>">
<?php
	if (in_array("tr_inv_canvas_item", explode(",", $tr_inv_canvas_master->getCurrentDetailTable())) && $tr_inv_canvas_item->DetailEdit) {
?>
...
<?php } ?>
<?php if (!$tr_inv_canvas_master_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $tr_inv_canvas_master_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $tr_inv_canvas_master_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
ew_ApplyTemplate("tpd_tr_inv_canvas_masteredit", "tpm_tr_inv_canvas_masteredit", "tr_inv_canvas_masteredit", "<?php echo $tr_inv_canvas_master->CustomExport ?>", ewVar.templateData.rows[0]);
jQuery("script.tr_inv_canvas_masteredit_js").each(function(){ew_AddScript(this.text);});
</script>
<script type="text/javascript">
ftr_inv_canvas_masteredit.Init();
</script>
<?php
$tr_inv_canvas_master_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$tr_inv_canvas_master_edit->Page_Terminate();
?>
