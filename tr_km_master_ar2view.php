...
$tr_km_master_ar2_view = NULL; // Initialize page object first

class ctr_km_master_ar2_view extends ctr_km_master_ar2 {
	...
	// Page object name
	var $PageObjName = 'tr_km_master_ar2_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["row_id"] <> "") {
				...
				$sReturnUrl = "tr_km_master_ar2list.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "tr_km_master_ar2list.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "tr_km_master_ar2list.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($tr_km_master_ar2_view)) $tr_km_master_ar2_view = new ctr_km_master_ar2_view();

// Page init
$tr_km_master_ar2_view->Page_Init();

// Page main
$tr_km_master_ar2_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tr_km_master_ar2_view->Page_Render();
?>
...
var CurrentForm = ftr_km_master_ar2view = new ew_Form("ftr_km_master_ar2view", "view");

// Form_CustomValidate event
ftr_km_master_ar2view.Form_CustomValidate = 
...
ftr_km_master_ar2view.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
ftr_km_master_ar2view.Lists["x_km_type"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ftr_km_master_ar2view.Lists["x_km_type"].Options = <?php echo json_encode($tr_km_master_ar2_view->km_type->Options()) ?>;
...
<div class="ewToolbar">
<?php $tr_km_master_ar2_view->ExportOptions->Render("body") ?>
<?php
	foreach ($tr_km_master_ar2_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php $tr_km_master_ar2_view->ShowPageHeader(); ?>
<?php
$tr_km_master_ar2_view->ShowMessage();
?>
<form name="ftr_km_master_ar2view" id="ftr_km_master_ar2view" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($tr_km_master_ar2_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tr_km_master_ar2_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="tr_km_master_ar2">
<input type="hidden" name="modal" value="<?php echo intval($tr_km_master_ar2_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($tr_km_master_ar2->row_id->Visible) { // row_id ?>
	<tr id="r_row_id">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar2_row_id"><?php echo $tr_km_master_ar2->row_id->FldCaption() ?></span></td>
		<td data-name="row_id"<?php echo $tr_km_master_ar2->row_id->CellAttributes() ?>>
<span id="el_tr_km_master_ar2_row_id">
<span<?php echo $tr_km_master_ar2->row_id->ViewAttributes() ?>>
<?php echo $tr_km_master_ar2->row_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tr_km_master_ar2->km_nomor->Visible) { // km_nomor ?>
	<tr id="r_km_nomor">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar2_km_nomor"><?php echo $tr_km_master_ar2->km_nomor->FldCaption() ?></span></td>
...
<?php echo $tr_km_master_ar2->km_nomor->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tr_km_master_ar2->km_tanggal->Visible) { // km_tanggal ?>
	<tr id="r_km_tanggal">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar2_km_tanggal"><?php echo $tr_km_master_ar2->km_tanggal->FldCaption() ?></span></td>
...
<?php echo $tr_km_master_ar2->km_tanggal->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tr_km_master_ar2->customer_id->Visible) { // customer_id ?>
	<tr id="r_customer_id">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar2_customer_id"><?php echo $tr_km_master_ar2->customer_id->FldCaption() ?></span></td>
...
<?php echo $tr_km_master_ar2->customer_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tr_km_master_ar2->customer_name->Visible) { // customer_name ?>
	<tr id="r_customer_name">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar2_customer_name"><?php echo $tr_km_master_ar2->customer_name->FldCaption() ?></span></td>
		<td data-name="customer_name"<?php echo $tr_km_master_ar2->customer_name->CellAttributes() ?>>
<span id="el_tr_km_master_ar2_customer_name">
<span<?php echo $tr_km_master_ar2->customer_name->ViewAttributes() ?>>
<?php echo $tr_km_master_ar2->customer_name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tr_km_master_ar2->km_type->Visible) { // km_type ?>
	<tr id="r_km_type">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar2_km_type"><?php echo $tr_km_master_ar2->km_type->FldCaption() ?></span></td>
		<td data-name="km_type"<?php echo $tr_km_master_ar2->km_type->CellAttributes() ?>>
<span id="el_tr_km_master_ar2_km_type">
<span<?php echo $tr_km_master_ar2->km_type->ViewAttributes() ?>>
<?php echo $tr_km_master_ar2->km_type->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tr_km_master_ar2->km_acc->Visible) { // km_acc ?>
	<tr id="r_km_acc">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar2_km_acc"><?php echo $tr_km_master_ar2->km_acc->FldCaption() ?></span></td>
		<td data-name="km_acc"<?php echo $tr_km_master_ar2->km_acc->CellAttributes() ?>>
<span id="el_tr_km_master_ar2_km_acc">
<span<?php echo $tr_km_master_ar2->km_acc->ViewAttributes() ?>>
<?php echo $tr_km_master_ar2->km_acc->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tr_km_master_ar2->cek_no->Visible) { // cek_no ?>
	<tr id="r_cek_no">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar2_cek_no"><?php echo $tr_km_master_ar2->cek_no->FldCaption() ?></span></td>
...
<?php echo $tr_km_master_ar2->cek_no->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tr_km_master_ar2->tgl_jt->Visible) { // tgl_jt ?>
	<tr id="r_tgl_jt">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar2_tgl_jt"><?php echo $tr_km_master_ar2->tgl_jt->FldCaption() ?></span></td>
...
<?php echo $tr_km_master_ar2->tgl_jt->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tr_km_master_ar2->cek_amt->Visible) { // cek_amt ?>
	<tr id="r_cek_amt">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar2_cek_amt"><?php echo $tr_km_master_ar2->cek_amt->FldCaption() ?></span></td>
		<td data-name="cek_amt"<?php echo $tr_km_master_ar2->cek_amt->CellAttributes() ?>>
<span id="el_tr_km_master_ar2_cek_amt">
<span<?php echo $tr_km_master_ar2->cek_amt->ViewAttributes() ?>>
<?php echo $tr_km_master_ar2->cek_amt->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tr_km_master_ar2->ret_number1->Visible) { // ret_number1 ?>
	<tr id="r_ret_number1">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar2_ret_number1"><?php echo $tr_km_master_ar2->ret_number1->FldCaption() ?></span></td>
		<td data-name="ret_number1"<?php echo $tr_km_master_ar2->ret_number1->CellAttributes() ?>>
<span id="el_tr_km_master_ar2_ret_number1">
<span<?php echo $tr_km_master_ar2->ret_number1->ViewAttributes() ?>>
<?php echo $tr_km_master_ar2->ret_number1->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tr_km_master_ar2->ret_date1->Visible) { // ret_date1 ?>
	<tr id="r_ret_date1">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar2_ret_date1"><?php echo $tr_km_master_ar2->ret_date1->FldCaption() ?></span></td>
		<td data-name="ret_date1"<?php echo $tr_km_master_ar2->ret_date1->CellAttributes() ?>>
<span id="el_tr_km_master_ar2_ret_date1">
<span<?php echo $tr_km_master_ar2->ret_date1->ViewAttributes() ?>>
<?php echo $tr_km_master_ar2->ret_date1->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tr_km_master_ar2->retur_amt1->Visible) { // retur_amt1 ?>
	<tr id="r_retur_amt1">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar2_retur_amt1"><?php echo $tr_km_master_ar2->retur_amt1->FldCaption() ?></span></td>
		<td data-name="retur_amt1"<?php echo $tr_km_master_ar2->retur_amt1->CellAttributes() ?>>
<span id="el_tr_km_master_ar2_retur_amt1">
<span<?php echo $tr_km_master_ar2->retur_amt1->ViewAttributes() ?>>
<?php echo $tr_km_master_ar2->retur_amt1->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tr_km_master_ar2->ret_number2->Visible) { // ret_number2 ?>
	<tr id="r_ret_number2">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar2_ret_number2"><?php echo $tr_km_master_ar2->ret_number2->FldCaption() ?></span></td>
		<td data-name="ret_number2"<?php echo $tr_km_master_ar2->ret_number2->CellAttributes() ?>>
<span id="el_tr_km_master_ar2_ret_number2">
<span<?php echo $tr_km_master_ar2->ret_number2->ViewAttributes() ?>>
<?php echo $tr_km_master_ar2->ret_number2->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tr_km_master_ar2->ret_date2->Visible) { // ret_date2 ?>
	<tr id="r_ret_date2">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar2_ret_date2"><?php echo $tr_km_master_ar2->ret_date2->FldCaption() ?></span></td>
		<td data-name="ret_date2"<?php echo $tr_km_master_ar2->ret_date2->CellAttributes() ?>>
<span id="el_tr_km_master_ar2_ret_date2">
<span<?php echo $tr_km_master_ar2->ret_date2->ViewAttributes() ?>>
<?php echo $tr_km_master_ar2->ret_date2->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tr_km_master_ar2->retur_amt2->Visible) { // retur_amt2 ?>
	<tr id="r_retur_amt2">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar2_retur_amt2"><?php echo $tr_km_master_ar2->retur_amt2->FldCaption() ?></span></td>
		<td data-name="retur_amt2"<?php echo $tr_km_master_ar2->retur_amt2->CellAttributes() ?>>
<span id="el_tr_km_master_ar2_retur_amt2">
<span<?php echo $tr_km_master_ar2->retur_amt2->ViewAttributes() ?>>
<?php echo $tr_km_master_ar2->retur_amt2->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tr_km_master_ar2->ret_number3->Visible) { // ret_number3 ?>
	<tr id="r_ret_number3">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar2_ret_number3"><?php echo $tr_km_master_ar2->ret_number3->FldCaption() ?></span></td>
		<td data-name="ret_number3"<?php echo $tr_km_master_ar2->ret_number3->CellAttributes() ?>>
<span id="el_tr_km_master_ar2_ret_number3">
<span<?php echo $tr_km_master_ar2->ret_number3->ViewAttributes() ?>>
<?php echo $tr_km_master_ar2->ret_number3->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tr_km_master_ar2->ret_date3->Visible) { // ret_date3 ?>
	<tr id="r_ret_date3">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar2_ret_date3"><?php echo $tr_km_master_ar2->ret_date3->FldCaption() ?></span></td>
		<td data-name="ret_date3"<?php echo $tr_km_master_ar2->ret_date3->CellAttributes() ?>>
<span id="el_tr_km_master_ar2_ret_date3">
<span<?php echo $tr_km_master_ar2->ret_date3->ViewAttributes() ?>>
<?php echo $tr_km_master_ar2->ret_date3->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tr_km_master_ar2->retur_amt3->Visible) { // retur_amt3 ?>
	<tr id="r_retur_amt3">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar2_retur_amt3"><?php echo $tr_km_master_ar2->retur_amt3->FldCaption() ?></span></td>
		<td data-name="retur_amt3"<?php echo $tr_km_master_ar2->retur_amt3->CellAttributes() ?>>
<span id="el_tr_km_master_ar2_retur_amt3">
<span<?php echo $tr_km_master_ar2->retur_amt3->ViewAttributes() ?>>
<?php echo $tr_km_master_ar2->retur_amt3->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tr_km_master_ar2->tunai_amt->Visible) { // tunai_amt ?>
	<tr id="r_tunai_amt">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar2_tunai_amt"><?php echo $tr_km_master_ar2->tunai_amt->FldCaption() ?></span></td>
		<td data-name="tunai_amt"<?php echo $tr_km_master_ar2->tunai_amt->CellAttributes() ?>>
<span id="el_tr_km_master_ar2_tunai_amt">
<span<?php echo $tr_km_master_ar2->tunai_amt->ViewAttributes() ?>>
<?php echo $tr_km_master_ar2->tunai_amt->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tr_km_master_ar2->dp_amt->Visible) { // dp_amt ?>
	<tr id="r_dp_amt">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar2_dp_amt"><?php echo $tr_km_master_ar2->dp_amt->FldCaption() ?></span></td>
		<td data-name="dp_amt"<?php echo $tr_km_master_ar2->dp_amt->CellAttributes() ?>>
<span id="el_tr_km_master_ar2_dp_amt">
<span<?php echo $tr_km_master_ar2->dp_amt->ViewAttributes() ?>>
<?php echo $tr_km_master_ar2->dp_amt->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tr_km_master_ar2->km_amt->Visible) { // km_amt ?>
	<tr id="r_km_amt">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar2_km_amt"><?php echo $tr_km_master_ar2->km_amt->FldCaption() ?></span></td>
...
<?php echo $tr_km_master_ar2->km_amt->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tr_km_master_ar2->km_notes->Visible) { // km_notes ?>
	<tr id="r_km_notes">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar2_km_notes"><?php echo $tr_km_master_ar2->km_notes->FldCaption() ?></span></td>
...
<?php echo $tr_km_master_ar2->km_notes->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tr_km_master_ar2->kode_depo->Visible) { // kode_depo ?>
	<tr id="r_kode_depo">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar2_kode_depo"><?php echo $tr_km_master_ar2->kode_depo->FldCaption() ?></span></td>
		<td data-name="kode_depo"<?php echo $tr_km_master_ar2->kode_depo->CellAttributes() ?>>
<span id="el_tr_km_master_ar2_kode_depo">
<span<?php echo $tr_km_master_ar2->kode_depo->ViewAttributes() ?>>
<?php echo $tr_km_master_ar2->kode_depo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tr_km_master_ar2->sales_id->Visible) { // sales_id ?>
	<tr id="r_sales_id">
		<td class="col-sm-2"><span id="elh_tr_km_master_ar2_sales_id"><?php echo $tr_km_master_ar2->sales_id->FldCaption() ?></span></td>
		<td data-name="sales_id"<?php echo $tr_km_master_ar2->sales_id->CellAttributes() ?>>
<span id="el_tr_km_master_ar2_sales_id">
<span<?php echo $tr_km_master_ar2->sales_id->ViewAttributes() ?>>
<?php echo $tr_km_master_ar2->sales_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
ftr_km_master_ar2view.Init();
</script>
<?php
$tr_km_master_ar2_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$tr_km_master_ar2_view->Page_Terminate();
?>
