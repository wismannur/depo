...
$tr_inv_item_edit = NULL; // Initialize page object first

class ctr_inv_item_edit extends ctr_inv_item {
	...
	// Page object name
	var $PageObjName = 'tr_inv_item_edit';
...
// Create page object
if (!isset($tr_inv_item_edit)) $tr_inv_item_edit = new ctr_inv_item_edit();

// Page init
$tr_inv_item_edit->Page_Init();

// Page main
$tr_inv_item_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tr_inv_item_edit->Page_Render();
?>
...
var CurrentForm = ftr_inv_itemedit = new ew_Form("ftr_inv_itemedit", "edit");

// Validate form
ftr_inv_itemedit.Validate = function() {
...
ftr_inv_itemedit.Form_CustomValidate = 
...
ftr_inv_itemedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
ftr_inv_itemedit.Lists["x_item_id"] = {"LinkField":"x_product_id","Ajax":true,"AutoFill":true,"DisplayFields":["x_product_name","","",""],"ParentFields":[],"ChildFields":["x_udet_id"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"view_products_unit_price"};
ftr_inv_itemedit.Lists["x_item_id"].Data = "<?php echo $tr_inv_item_edit->item_id->LookupFilterQuery(FALSE, "edit") ?>";
ftr_inv_itemedit.AutoSuggests["x_item_id"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $tr_inv_item_edit->item_id->LookupFilterQuery(TRUE, "edit"))) ?>;
ftr_inv_itemedit.Lists["x_udet_id"] = {"LinkField":"x_udet_id","Ajax":true,"AutoFill":true,"DisplayFields":["x_unit_name","","",""],"ParentFields":["x_item_id"],"ChildFields":[],"FilterFields":["x_product_id"],"Options":[],"Template":"","LinkTable":"tbl_unit_detail"};
ftr_inv_itemedit.Lists["x_udet_id"].Data = "<?php echo $tr_inv_item_edit->udet_id->LookupFilterQuery(FALSE, "edit") ?>";
...
<?php $tr_inv_item_edit->ShowPageHeader(); ?>
<?php
$tr_inv_item_edit->ShowMessage();
?>
<form name="ftr_inv_itemedit" id="ftr_inv_itemedit" class="<?php echo $tr_inv_item_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($tr_inv_item_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tr_inv_item_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="tr_inv_item">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($tr_inv_item_edit->IsModal) ?>">
...
<?php } ?>
<?php if (!$tr_inv_item_edit->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($tr_inv_item_edit->IsMobileOrModal) { ?>
<div class="ewEditDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_tr_inv_itemedit" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
<?php if ($tr_inv_item->item_id->Visible) { // item_id ?>
<?php if ($tr_inv_item_edit->IsMobileOrModal) { ?>
	<div id="r_item_id" class="form-group">
		<label id="elh_tr_inv_item_item_id" class="<?php echo $tr_inv_item_edit->LeftColumnClass ?>"><?php echo $tr_inv_item->item_id->FldCaption() ?></label>
		<div class="<?php echo $tr_inv_item_edit->RightColumnClass ?>"><div<?php echo $tr_inv_item->item_id->CellAttributes() ?>>
...
<script type="text/javascript">
ftr_inv_itemedit.CreateAutoSuggest({"id":"x_item_id","forceSelect":true});
</script>
...
<?php if ($tr_inv_item_edit->IsMobileOrModal) { ?>
	<div id="r_item_code" class="form-group">
		<label id="elh_tr_inv_item_item_code" for="x_item_code" class="<?php echo $tr_inv_item_edit->LeftColumnClass ?>"><?php echo $tr_inv_item->item_code->FldCaption() ?></label>
		<div class="<?php echo $tr_inv_item_edit->RightColumnClass ?>"><div<?php echo $tr_inv_item->item_code->CellAttributes() ?>>
...
<?php if ($tr_inv_item_edit->IsMobileOrModal) { ?>
	<div id="r_udet_id" class="form-group">
		<label id="elh_tr_inv_item_udet_id" for="x_udet_id" class="<?php echo $tr_inv_item_edit->LeftColumnClass ?>"><?php echo $tr_inv_item->udet_id->FldCaption() ?></label>
		<div class="<?php echo $tr_inv_item_edit->RightColumnClass ?>"><div<?php echo $tr_inv_item->udet_id->CellAttributes() ?>>
...
<?php if ($tr_inv_item_edit->IsMobileOrModal) { ?>
	<div id="r_item_qty" class="form-group">
		<label id="elh_tr_inv_item_item_qty" for="x_item_qty" class="<?php echo $tr_inv_item_edit->LeftColumnClass ?>"><?php echo $tr_inv_item->item_qty->FldCaption() ?></label>
		<div class="<?php echo $tr_inv_item_edit->RightColumnClass ?>"><div<?php echo $tr_inv_item->item_qty->CellAttributes() ?>>
...
<?php if ($tr_inv_item_edit->IsMobileOrModal) { ?>
	<div id="r_item_price" class="form-group">
		<label id="elh_tr_inv_item_item_price" for="x_item_price" class="<?php echo $tr_inv_item_edit->LeftColumnClass ?>"><?php echo $tr_inv_item->item_price->FldCaption() ?></label>
		<div class="<?php echo $tr_inv_item_edit->RightColumnClass ?>"><div<?php echo $tr_inv_item->item_price->CellAttributes() ?>>
...
<?php if ($tr_inv_item_edit->IsMobileOrModal) { ?>
	<div id="r_item_disc" class="form-group">
		<label id="elh_tr_inv_item_item_disc" for="x_item_disc" class="<?php echo $tr_inv_item_edit->LeftColumnClass ?>"><?php echo $tr_inv_item->item_disc->FldCaption() ?></label>
		<div class="<?php echo $tr_inv_item_edit->RightColumnClass ?>"><div<?php echo $tr_inv_item->item_disc->CellAttributes() ?>>
...
<?php if ($tr_inv_item_edit->IsMobileOrModal) { ?>
	<div id="r_item_amt" class="form-group">
		<label id="elh_tr_inv_item_item_amt" for="x_item_amt" class="<?php echo $tr_inv_item_edit->LeftColumnClass ?>"><?php echo $tr_inv_item->item_amt->FldCaption() ?></label>
		<div class="<?php echo $tr_inv_item_edit->RightColumnClass ?>"><div<?php echo $tr_inv_item->item_amt->CellAttributes() ?>>
...
<input type="hidden" data-table="tr_inv_item" data-field="x_item_name" name="x_item_name" id="x_item_name" value="<?php echo ew_HtmlEncode($tr_inv_item->item_name->CurrentValue) ?>">
</span>
<span id="el_tr_inv_item_unit_id">
<input type="hidden" data-table="tr_inv_item" data-field="x_unit_id" name="x_unit_id" id="x_unit_id" value="<?php echo ew_HtmlEncode($tr_inv_item->unit_id->CurrentValue) ?>">
</span>
<input type="hidden" data-table="tr_inv_item" data-field="x_row_id" name="x_row_id" id="x_row_id" value="<?php echo ew_HtmlEncode($tr_inv_item->row_id->CurrentValue) ?>">
<?php if (!$tr_inv_item_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $tr_inv_item_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $tr_inv_item_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
ftr_inv_itemedit.Init();
</script>
<?php
$tr_inv_item_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$tr_inv_item_edit->Page_Terminate();
?>
