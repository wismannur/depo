...
$tbl_depo_add = NULL; // Initialize page object first

class ctbl_depo_add extends ctbl_depo {
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["kode_depo"] != "") {
				...
				$this->setKey("kode_depo", $this->kode_depo->CurrentValue); // Set up key
			} else {
				$this->setKey("kode_depo", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "tbl_depoview.php")
	...
	function LoadDefaultValues() {
		...
		$this->nama_depo->CurrentValue = NULL;
		$this->nama_depo->OldValue = $this->nama_depo->CurrentValue;
		...
		$this->alamat3->CurrentValue = NULL;
		$this->alamat3->OldValue = $this->alamat3->CurrentValue;
		...
		$this->trx_kode->CurrentValue = NULL;
		$this->trx_kode->OldValue = $this->trx_kode->CurrentValue;
	}
	...
	function NewRow() {
		...
		$row['nama_depo'] = $this->nama_depo->CurrentValue;
		$row['alamat1'] = $this->alamat1->CurrentValue;
		$row['alamat2'] = $this->alamat2->CurrentValue;
		$row['alamat3'] = $this->alamat3->CurrentValue;
		$row['telp'] = $this->telp->CurrentValue;
		$row['fax'] = $this->fax->CurrentValue;
		$row['penanggung_jawab'] = $this->penanggung_jawab->CurrentValue;
		$row['trx_kode'] = $this->trx_kode->CurrentValue;
		return $row;
	}
	...
	function AddRow($rsold = NULL) {
		...
		// kode_depo
		$this->kode_depo->SetDbValueDef($rsnew, $this->kode_depo->CurrentValue, "", FALSE);

		// nama_depo
		$this->nama_depo->SetDbValueDef($rsnew, $this->nama_depo->CurrentValue, NULL, FALSE);
		...
		// alamat3
		$this->alamat3->SetDbValueDef($rsnew, $this->alamat3->CurrentValue, NULL, FALSE);
		...
		// penanggung_jawab
		$this->penanggung_jawab->SetDbValueDef($rsnew, $this->penanggung_jawab->CurrentValue, NULL, FALSE);

		// trx_kode
		$this->trx_kode->SetDbValueDef($rsnew, $this->trx_kode->CurrentValue, NULL, FALSE);
		...
		if ($bInsertRow && $this->ValidateKey && strval($rsnew['kode_depo']) == "") {
...
// Create page object
if (!isset($tbl_depo_add)) $tbl_depo_add = new ctbl_depo_add();

// Page init
$tbl_depo_add->Page_Init();

// Page main
$tbl_depo_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tbl_depo_add->Page_Render();
?>
...
var CurrentForm = ftbl_depoadd = new ew_Form("ftbl_depoadd", "add");

// Validate form
ftbl_depoadd.Validate = function() {
...
ftbl_depoadd.Form_CustomValidate = 
...
ftbl_depoadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $tbl_depo_add->ShowPageHeader(); ?>
<?php
$tbl_depo_add->ShowMessage();
?>
<form name="ftbl_depoadd" id="ftbl_depoadd" class="<?php echo $tbl_depo_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($tbl_depo_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tbl_depo_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="tbl_depo">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($tbl_depo_add->IsModal) ?>">
<?php if (!$tbl_depo_add->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($tbl_depo_add->IsMobileOrModal) { ?>
<div class="ewAddDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_tbl_depoadd" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
<?php if ($tbl_depo->kode_depo->Visible) { // kode_depo ?>
<?php if ($tbl_depo_add->IsMobileOrModal) { ?>
	<div id="r_kode_depo" class="form-group">
		<label id="elh_tbl_depo_kode_depo" for="x_kode_depo" class="<?php echo $tbl_depo_add->LeftColumnClass ?>"><?php echo $tbl_depo->kode_depo->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $tbl_depo_add->RightColumnClass ?>"><div<?php echo $tbl_depo->kode_depo->CellAttributes() ?>>
<span id="el_tbl_depo_kode_depo">
<input type="text" data-table="tbl_depo" data-field="x_kode_depo" name="x_kode_depo" id="x_kode_depo" size="30" maxlength="3" placeholder="<?php echo ew_HtmlEncode($tbl_depo->kode_depo->getPlaceHolder()) ?>" value="<?php echo $tbl_depo->kode_depo->EditValue ?>"<?php echo $tbl_depo->kode_depo->EditAttributes() ?>>
</span>
...
<?php if ($tbl_depo_add->IsMobileOrModal) { ?>
	<div id="r_nama_depo" class="form-group">
		<label id="elh_tbl_depo_nama_depo" for="x_nama_depo" class="<?php echo $tbl_depo_add->LeftColumnClass ?>"><?php echo $tbl_depo->nama_depo->FldCaption() ?></label>
		<div class="<?php echo $tbl_depo_add->RightColumnClass ?>"><div<?php echo $tbl_depo->nama_depo->CellAttributes() ?>>
...
<?php if ($tbl_depo_add->IsMobileOrModal) { ?>
	<div id="r_alamat1" class="form-group">
		<label id="elh_tbl_depo_alamat1" for="x_alamat1" class="<?php echo $tbl_depo_add->LeftColumnClass ?>"><?php echo $tbl_depo->alamat1->FldCaption() ?></label>
		<div class="<?php echo $tbl_depo_add->RightColumnClass ?>"><div<?php echo $tbl_depo->alamat1->CellAttributes() ?>>
...
<?php if ($tbl_depo_add->IsMobileOrModal) { ?>
	<div id="r_alamat2" class="form-group">
		<label id="elh_tbl_depo_alamat2" for="x_alamat2" class="<?php echo $tbl_depo_add->LeftColumnClass ?>"><?php echo $tbl_depo->alamat2->FldCaption() ?></label>
		<div class="<?php echo $tbl_depo_add->RightColumnClass ?>"><div<?php echo $tbl_depo->alamat2->CellAttributes() ?>>
...
<?php if ($tbl_depo_add->IsMobileOrModal) { ?>
	<div id="r_alamat3" class="form-group">
		<label id="elh_tbl_depo_alamat3" for="x_alamat3" class="<?php echo $tbl_depo_add->LeftColumnClass ?>"><?php echo $tbl_depo->alamat3->FldCaption() ?></label>
		<div class="<?php echo $tbl_depo_add->RightColumnClass ?>"><div<?php echo $tbl_depo->alamat3->CellAttributes() ?>>
...
<?php if ($tbl_depo_add->IsMobileOrModal) { ?>
	<div id="r_telp" class="form-group">
		<label id="elh_tbl_depo_telp" for="x_telp" class="<?php echo $tbl_depo_add->LeftColumnClass ?>"><?php echo $tbl_depo->telp->FldCaption() ?></label>
		<div class="<?php echo $tbl_depo_add->RightColumnClass ?>"><div<?php echo $tbl_depo->telp->CellAttributes() ?>>
...
<?php if ($tbl_depo_add->IsMobileOrModal) { ?>
	<div id="r_fax" class="form-group">
		<label id="elh_tbl_depo_fax" for="x_fax" class="<?php echo $tbl_depo_add->LeftColumnClass ?>"><?php echo $tbl_depo->fax->FldCaption() ?></label>
		<div class="<?php echo $tbl_depo_add->RightColumnClass ?>"><div<?php echo $tbl_depo->fax->CellAttributes() ?>>
...
<?php if ($tbl_depo_add->IsMobileOrModal) { ?>
	<div id="r_penanggung_jawab" class="form-group">
		<label id="elh_tbl_depo_penanggung_jawab" for="x_penanggung_jawab" class="<?php echo $tbl_depo_add->LeftColumnClass ?>"><?php echo $tbl_depo->penanggung_jawab->FldCaption() ?></label>
		<div class="<?php echo $tbl_depo_add->RightColumnClass ?>"><div<?php echo $tbl_depo->penanggung_jawab->CellAttributes() ?>>
...
<?php if ($tbl_depo_add->IsMobileOrModal) { ?>
	<div id="r_trx_kode" class="form-group">
		<label id="elh_tbl_depo_trx_kode" for="x_trx_kode" class="<?php echo $tbl_depo_add->LeftColumnClass ?>"><?php echo $tbl_depo->trx_kode->FldCaption() ?></label>
		<div class="<?php echo $tbl_depo_add->RightColumnClass ?>"><div<?php echo $tbl_depo->trx_kode->CellAttributes() ?>>
...
<?php } ?>
<?php if (!$tbl_depo_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $tbl_depo_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $tbl_depo_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
