...
$tr_retp_item_grid = NULL; // Initialize page object first

class ctr_retp_item_grid extends ctr_retp_item {
	...
	// Page object name
	var $PageObjName = 'tr_retp_item_grid';

	// Grid form hidden field names
	var $FormName = 'ftr_retp_itemgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["tr_retp_item"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function SetupMasterParms() {
		...
		if ($sMasterTblVar == "tr_retp_master") {
			...
			if ($GLOBALS["tr_retp_master"]->EventCancelled) $this->EventCancelled = TRUE;
		}
