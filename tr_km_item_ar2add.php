...
$tr_km_item_ar2_add = NULL; // Initialize page object first

class ctr_km_item_ar2_add extends ctr_km_item_ar2 {
	...
	// Page object name
	var $PageObjName = 'tr_km_item_ar2_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "tr_km_item_ar2view.php")
...
// Create page object
if (!isset($tr_km_item_ar2_add)) $tr_km_item_ar2_add = new ctr_km_item_ar2_add();

// Page init
$tr_km_item_ar2_add->Page_Init();

// Page main
$tr_km_item_ar2_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tr_km_item_ar2_add->Page_Render();
?>
...
var CurrentForm = ftr_km_item_ar2add = new ew_Form("ftr_km_item_ar2add", "add");

// Validate form
ftr_km_item_ar2add.Validate = function() {
...
ftr_km_item_ar2add.Form_CustomValidate = 
...
ftr_km_item_ar2add.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
ftr_km_item_ar2add.Lists["x_customer_id"] = {"LinkField":"x_customer_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_customer_name","","",""],"ParentFields":[],"ChildFields":["x_inv_number"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tbl_customer"};
ftr_km_item_ar2add.Lists["x_customer_id"].Data = "<?php echo $tr_km_item_ar2_add->customer_id->LookupFilterQuery(FALSE, "add") ?>";
ftr_km_item_ar2add.Lists["x_inv_number"] = {"LinkField":"x_inv_number","Ajax":true,"AutoFill":true,"DisplayFields":["x_inv_number","","",""],"ParentFields":["x_customer_id"],"ChildFields":[],"FilterFields":["x_customer_id"],"Options":[],"Template":"","LinkTable":"tr_inv_canvas_master"};
ftr_km_item_ar2add.Lists["x_inv_number"].Data = "<?php echo $tr_km_item_ar2_add->inv_number->LookupFilterQuery(FALSE, "add") ?>";
...
<?php $tr_km_item_ar2_add->ShowPageHeader(); ?>
<?php
$tr_km_item_ar2_add->ShowMessage();
?>
<form name="ftr_km_item_ar2add" id="ftr_km_item_ar2add" class="<?php echo $tr_km_item_ar2_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($tr_km_item_ar2_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tr_km_item_ar2_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="tr_km_item_ar2">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($tr_km_item_ar2_add->IsModal) ?>">
...
<?php } ?>
<?php if (!$tr_km_item_ar2_add->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($tr_km_item_ar2_add->IsMobileOrModal) { ?>
<div class="ewAddDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_tr_km_item_ar2add" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
<?php if ($tr_km_item_ar2->master_id->Visible) { // master_id ?>
<?php if ($tr_km_item_ar2_add->IsMobileOrModal) { ?>
	<div id="r_master_id" class="form-group">
		<label id="elh_tr_km_item_ar2_master_id" for="x_master_id" class="<?php echo $tr_km_item_ar2_add->LeftColumnClass ?>"><?php echo $tr_km_item_ar2->master_id->FldCaption() ?></label>
		<div class="<?php echo $tr_km_item_ar2_add->RightColumnClass ?>"><div<?php echo $tr_km_item_ar2->master_id->CellAttributes() ?>>
...
<?php if ($tr_km_item_ar2_add->IsMobileOrModal) { ?>
	<div id="r_customer_id" class="form-group">
		<label id="elh_tr_km_item_ar2_customer_id" for="x_customer_id" class="<?php echo $tr_km_item_ar2_add->LeftColumnClass ?>"><?php echo $tr_km_item_ar2->customer_id->FldCaption() ?></label>
		<div class="<?php echo $tr_km_item_ar2_add->RightColumnClass ?>"><div<?php echo $tr_km_item_ar2->customer_id->CellAttributes() ?>>
...
<?php if ($tr_km_item_ar2_add->IsMobileOrModal) { ?>
	<div id="r_inv_number" class="form-group">
		<label id="elh_tr_km_item_ar2_inv_number" for="x_inv_number" class="<?php echo $tr_km_item_ar2_add->LeftColumnClass ?>"><?php echo $tr_km_item_ar2->inv_number->FldCaption() ?></label>
		<div class="<?php echo $tr_km_item_ar2_add->RightColumnClass ?>"><div<?php echo $tr_km_item_ar2->inv_number->CellAttributes() ?>>
...
<?php if ($tr_km_item_ar2_add->IsMobileOrModal) { ?>
	<div id="r_inv_date" class="form-group">
		<label id="elh_tr_km_item_ar2_inv_date" for="x_inv_date" class="<?php echo $tr_km_item_ar2_add->LeftColumnClass ?>"><?php echo $tr_km_item_ar2->inv_date->FldCaption() ?></label>
		<div class="<?php echo $tr_km_item_ar2_add->RightColumnClass ?>"><div<?php echo $tr_km_item_ar2->inv_date->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("ftr_km_item_ar2add", "x_inv_date", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($tr_km_item_ar2_add->IsMobileOrModal) { ?>
	<div id="r_inv_amt" class="form-group">
		<label id="elh_tr_km_item_ar2_inv_amt" for="x_inv_amt" class="<?php echo $tr_km_item_ar2_add->LeftColumnClass ?>"><?php echo $tr_km_item_ar2->inv_amt->FldCaption() ?></label>
		<div class="<?php echo $tr_km_item_ar2_add->RightColumnClass ?>"><div<?php echo $tr_km_item_ar2->inv_amt->CellAttributes() ?>>
...
<?php if ($tr_km_item_ar2_add->IsMobileOrModal) { ?>
	<div id="r_paid_amt" class="form-group">
		<label id="elh_tr_km_item_ar2_paid_amt" for="x_paid_amt" class="<?php echo $tr_km_item_ar2_add->LeftColumnClass ?>"><?php echo $tr_km_item_ar2->paid_amt->FldCaption() ?></label>
		<div class="<?php echo $tr_km_item_ar2_add->RightColumnClass ?>"><div<?php echo $tr_km_item_ar2->paid_amt->CellAttributes() ?>>
...
<?php if ($tr_km_item_ar2_add->IsMobileOrModal) { ?>
	<div id="r_acc_no" class="form-group">
		<label id="elh_tr_km_item_ar2_acc_no" for="x_acc_no" class="<?php echo $tr_km_item_ar2_add->LeftColumnClass ?>"><?php echo $tr_km_item_ar2->acc_no->FldCaption() ?></label>
		<div class="<?php echo $tr_km_item_ar2_add->RightColumnClass ?>"><div<?php echo $tr_km_item_ar2->acc_no->CellAttributes() ?>>
...
<?php } ?>
<?php if (!$tr_km_item_ar2_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $tr_km_item_ar2_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $tr_km_item_ar2_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
ftr_km_item_ar2add.Init();
</script>
<?php
$tr_km_item_ar2_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$tr_km_item_ar2_add->Page_Terminate();
?>
