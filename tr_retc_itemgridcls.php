...
$tr_retc_item_grid = NULL; // Initialize page object first

class ctr_retc_item_grid extends ctr_retc_item {
	...
	// Page object name
	var $PageObjName = 'tr_retc_item_grid';

	// Grid form hidden field names
	var $FormName = 'ftr_retc_itemgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["tr_retc_item"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function SetupMasterParms() {
		...
		if ($sMasterTblVar == "tr_retc_master") {
			...
			if ($GLOBALS["tr_retc_master"]->EventCancelled) $this->EventCancelled = TRUE;
		}
